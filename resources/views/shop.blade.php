    ...
    <ul class="mainmenu">
        ...
        <div class="mobile-menu-bottom">
            ...
            <ul class="navbar-top-left rbt-information-list justify-content-center">
                <li>
                    <a href="/cdn-cgi/l/email-protection#e78f828b8b88a7829f868a978b82c984888a"><i class="fa-light fa-envelope"></i><span class="__cf_email__" data-cfemail="8eebf6efe3fee2ebcee9e3efe7e2a0ede1e3">[email&#160;protected]</span></a>
                </li>
                <li>
                    ...
                    <div class="rbt-sidebar-left-content-footer">
                        <div class="rbt-sidebar-contact-area">
                            <div class="rbt-sidebar-contact-inner rbt-link-hover">
                                ...
                                <a class="rbt-contact-links" href="/cdn-cgi/l/email-protection#3d595850527d58455c504d5158135e5250"><span class="__cf_email__" data-cfemail="2743424a4867425f464a574b420944484a">[email&#160;protected]</span></a>
                                ...
                                <div class="rbt-card rbt-product-card rbt-list-view-variation rbt-list-view-sm">
                                    <div class="inner rbt-scroll-trigger fade_in animation-order-1">
                                        <div class="rbt-card-body">
                                            ...
                                            <h3 class="rbt-card-title h6"><a href="product-single-default.html">Beats
                                        ...
                                        <div class="rbt-card-img rbt-bg-color-default rbt-curved-style-box">
                                            <a href="product-single-default.html"><img src="{{ asset('assets/images/product-img/electronics/electronics-bg-trans-list-01.webp') }}" alt="Card Image"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="rbt-card rbt-product-card rbt-list-view-variation rbt-list-view-sm">
                                    <div class="inner rbt-scroll-trigger fade_in animation-order-2">
                                        <div class="rbt-card-body">
                                            ...
                                            <h3 class="rbt-card-title h6"><a href="product-single-default.html">Apple
                                        ...
                                        <div class="rbt-card-img rbt-bg-color-default rbt-curved-style-box">
                                            <a href="product-single-default.html"><img src="{{ asset('assets/images/product-img/electronics/electronics-bg-trans-list-02.webp') }}" alt="Card Image"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="rbt-card rbt-product-card rbt-list-view-variation rbt-list-view-sm">
                                    <div class="inner rbt-scroll-trigger fade_in animation-order-3">
                                        <div class="rbt-card-body">
                                            ...
                                            <h3 class="rbt-card-title h6"><a href="product-single-default.html"> DJI OM
                                                    5
                                        ...
                                        <div class="rbt-card-img rbt-bg-color-default rbt-curved-style-box">
                                            <a href="product-single-default.html"><img src="{{ asset('assets/images/product-img/electronics/electronics-bg-trans-list-03.webp') }}" alt="Card Image"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12 mt--24">
                                <div class="rbt-card rbt-product-card rbt-list-view-variation rbt-list-view-sm">
                                    <div class="inner rbt-scroll-trigger fade_in animation-order-4">
                                        ...
                                        <div class="rbt-card-img rbt-bg-color-default rbt-curved-style-box">
                                            <a href="product-single-default.html"><img src="{{ asset('assets/images/product-img/electronics/electronics-bg-trans-list-04.webp') }}" alt="Card Image"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12 mt--24">
                                <div class="rbt-card rbt-product-card rbt-list-view-variation rbt-list-view-sm">
                                    <div class="inner rbt-scroll-trigger fade_in animation-order-5">
                                        ...
                                        <div class="rbt-card-img rbt-bg-color-default rbt-curved-style-box">
                                            <a href="product-single-default.html"><img src="{{ asset('assets/images/product-img/electronics/electronics-bg-trans-list-05.webp') }}" alt="Card Image"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12 mt--24">
                                <div class="rbt-card rbt-product-card rbt-list-view-variation rbt-list-view-sm">
                                    <div class="inner rbt-scroll-trigger fade_in animation-order-6">
                                        ...
                                        <div class="rbt-card-img rbt-bg-color-default rbt-curved-style-box">
                                            <a href="product-single-default.html"><img src="{{ asset('assets/images/product-img/electronics/electronics-bg-trans-list-06.webp') }}" alt="Card Image"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!-- End Wishlist Modal Area  -->
            ...
            <div class="col-lg-12">
                <div class="rbt-breadcrumb-inner text-left">
                    <ul class="rbt-breadcrumb-page-list justify-content-start mt--0">
                        ...
                        <li class="rbt-breadcrumb-item"><a href="#">Pages</a></li>
                        <li>
                            <div class="icon-right"><i class="fa-solid fa-chevron-right"></i></div>
                        </li>
    ...
    <div class="rbt-component-area rbt-page-banner-content">
        <div class="container">
            <div class="row">
    <div class="col-lg-12">
        <div class="rbt-component-banner radius-8 rbt-scroll-trigger fade_in animation-order-1">
            <div class="mega-top-banner bg-three">
                <div class="rbt-banner-inner w-100">
                    <div class="rbt-banner-content">
                        <h2 class="title">Buy One and Get 50% Off the Second Purchase Now</h2>
                        <p class="b3 desc">Send us your idea, it may appear on Unimart.</p>
                    </div>
                    <div class="pricing-action d-flex align-items-center rbt-gap--8">
                        <div class="rbt-pricing-part d-flex">
                            <span class="rbt-price-text offer-price">Rs. 189.00</span>
                            <del class="rbt-dis-price-text">Rs. 295.00</del>
                        </div>
                    ...
                    <a href="#" class="product-img position-bottom d-none d-xl-block"><img src="{{ asset('assets/images/splash/menu-banner/menu-prd-01.webp') }}" alt="Eccommerce Product"></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Start Component Area -->
    <div class="rbt-component-area rbt-catagories-area pt--0 pt_sm--16 pt_md--16 rbt-bg-color-white">
        <div class="container">
            <!-- Start Component Area -->
<div class="row row--12 align-items-end rbt-tablet-row rbt-mobile-row">

    <!-- Start Single Card  -->
    <div class="col-lg-1-8 col-md-2 col-sm-3 col-3">
        <a class="rbt-cat-box rbt-cat-box-1 text-center rbt-scroll-trigger fade_in animation-order-1" href="shop-by-categories.html">
            <div class="inner">
                <div class="rbt-image-portion">
                    <img src="{{ asset('assets/images/catagory-img/cat-img-01.webp') }}" alt="Catagory Product Images">
                </div>
                <div class="content">
                    <p class="title">Apple Phone</p>
                </div>
            </div>
        </a>
    </div>
    ...
    <!-- Start Single Card  -->
    <div class="col-lg-1-8 col-md-2 col-sm-3 col-3">
        <a class="rbt-cat-box rbt-cat-box-1 text-center rbt-scroll-trigger fade_in animation-order-2" href="shop-by-categories.html">
            <div class="inner">
                <div class="rbt-image-portion">
                    <img src="{{ asset('assets/images/catagory-img/cat-img-02.webp') }}" alt="Catagory Product Images">
                </div>
                <div class="content">
                    <p class="title">Jacket & Polo</p>
                </div>
            </div>
        </a>
    </div>
    ...
    <!-- Start Single Card  -->
    <div class="col-lg-1-8 col-md-2 col-sm-3 col-3">
        <a class="rbt-cat-box rbt-cat-box-1 text-center rbt-scroll-trigger fade_in animation-order-3" href="shop-by-categories.html">
            <div class="inner">
                <div class="rbt-image-portion">
                    <img src="{{ asset('assets/images/catagory-img/cat-img-03.webp') }}" alt="Catagory Product Images">
                </div>
                <div class="content">
                    <p class="title">Printer & Ink</p>
                </div>
            </div>
        </a>
    </div>
    ...
    <!-- Start Single Card  -->
    <div class="col-lg-1-8 col-md-2 col-sm-3 col-3">
        <a class="rbt-cat-box rbt-cat-box-1 text-center rbt-scroll-trigger fade_in animation-order-4" href="shop-by-categories.html">
            <div class="inner">
                <div class="rbt-image-portion">
                    <img src="{{ asset('assets/images/catagory-img/cat-img-04.webp') }}" alt="Catagory Product Images">
                </div>
                <div class="content">
                    <p class="title">Doll Panda</p>
                </div>
            </div>
        </a>
    </div>
    ...
    <!-- Start Single Card  -->
    <div class="col-lg-1-8 col-md-2 col-sm-3 col-3">
        <a class="rbt-cat-box rbt-cat-box-1 text-center rbt-scroll-trigger fade_in animation-order-5" href="shop-by-categories.html">
            <div class="inner">
                <div class="rbt-image-portion">
                    <img class="rbt-sm-max-height" src="{{ asset('assets/images/catagory-img/cat-img-05.webp') }}" alt="Catagory Product Images">
                </div>
                <div class="content">
                    <p class="title">VIP Chair</p>
                </div>
            </div>
        </a>
    </div>
    ...
    <!-- Start Single Card  -->
    <div class="col-lg-1-8 col-md-2 col-sm-3 col-3">
        <a class="rbt-cat-box rbt-cat-box-1 text-center rbt-scroll-trigger fade_in animation-order-6" href="shop-by-categories.html">
            <div class="inner">
                <div class="rbt-image-portion">
                    <img src="{{ asset('assets/images/catagory-img/cat-img-06.webp') }}" alt="Catagory Product Images">
                </div>
                <div class="content">
                    <p class="title">Stylish Bags</p>
                </div>
            </div>
        </a>
    </div>
    ...
    <!-- Start Single Card  -->
    <div class="col-lg-1-8 col-md-2 col-sm-3 col-3">
        <a class="rbt-cat-box rbt-cat-box-1 text-center rbt-scroll-trigger fade_in animation-order-7" href="shop-by-categories.html">
            <div class="inner">
                <div class="rbt-image-portion">
                    <img src="{{ asset('assets/images/catagory-img/cat-img-03.webp') }}" alt="Catagory Product Images">
                </div>
    ...
    <!-- Start Single Card  -->
    <div class="col-lg-1-8 col-md-2 col-sm-3 col-3">
        <a class="rbt-cat-box rbt-cat-box-1 text-center rbt-scroll-trigger fade_in animation-order-8" href="shop-by-categories.html">
            <div class="inner">
                <div class="rbt-image-portion">
                    <img src="{{ asset('assets/images/catagory-img/cat-img-04.webp') }}" alt="Catagory Product Images">
                </div>
...
<!-- End Component Area -->
    ...
    <div class="rbt-component-area rbt-shop-filter-area rbt-bg-color-white rbt-section-gapBottom">
        <div class="container">
            <div class="row row--16 mt_dec--24 overflow-hidden">
                <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12 mt--24 d-none d-lg-block">
                    <aside class="rbt-sidebar has-rbt-fshape d-none d-lg-block">
        ...
        <div class="rbt-sidebar-bottom">
            ...
            <div class="rbt-single-widget rbt-widget-categories">
                <div class="rbt-single-widget-inner">
                    <h2 class="rbt-widget-title rbt-widget-title-without-border h4">
                        <a data-bs-toggle="collapse" href="#rbt-collapse-6" role="button" aria-expanded="false" aria-controls="rbt-collapse-6">
                            Customer Reviews
                            <span class="icon"><i class="fa-regular fa-chevron-down"></i></span>
                        </a>
                    </h2>
                    <div class="collapse show" id="rbt-collapse-6">
                        <ul class="rbt-sidebar-list-wrapper rbt-categories-review-list">
                            <li class="rbt-review-group">
                                <a href="#" class="rbt-card-rating d-flex">
                                    <ul class="rbt-rating-icon-list">
                                        <li><i class="fa-solid fa-star rbt-rated-icon"></i></li>
                                        <li><i class="fa-solid fa-star rbt-rated-icon"></i></li>
                                        <li><i class="fa-solid fa-star rbt-rated-icon"></i></li>
                ...
                <div class="rbt-single-widget-inner">
                    ...
                    <div class="rbt-inner-search-field border-0 pt--16 pb--16">
                        <div class="rbt-search-input-section rbt-sm-search-section">
                            <input class="rbt-filter-search-field" type="text" placeholder="Search and Select Product">
                            <span class="search-btn search-btn-dark bg-transparent rbt-text-color-gray-400"><i class="fa-sharp fa-solid fa-magnifying-glass"></i></span>
                        </div>
                    </div>
                    <div class="collapse show" id="rbt-collapse-8">
                        <div class="rbt-has-show-more">
                            <span class="rbt-filter-item-not-found rbt-text-color-danger">Color not matched</span>
                            <ul class="rbt-sidebar-list-wrapper rbt-categories-list-color-swatch rbt-search-filter-item-list rbt-has-show-more-inner-content">
                                ...
                                <li class="rbt-color-swatch-group">
                                    <a href="#" class="rbt-color-swatch-content">
                                        <span class="rbt-color-swatch">
                                            <span class="rbt-color-swatch-bg rbt-swatch-bg-brown"></span>
                                            <span class="rbt-color-swatch-text">Brown</span>
                                        </span>
                                    </a>
                                    <span class="rbt-color-swatch-count">(90)</span>
                                </li>
                                <li class="rbt-color-swatch-group">
                                    <a href="#" class="rbt-color-swatch-content">
                                        <span class="rbt-color-swatch">
                                            <span class="rbt-color-swatch-bg rbt-swatch-bg-gray"></span>
                                            <span class="rbt-color-swatch-text">Gray</span>
                                        </span>
                                    </a>
                                    <span class="rbt-color-swatch-count">(33)</span>
                                </li>
                                <li class="rbt-color-swatch-group">
                                    <a href="#" class="rbt-color-swatch-content">
                                        <span class="rbt-color-swatch">
                                            <span class="rbt-color-swatch-bg rbt-swatch-bg-green"></span>
                                            <span class="rbt-color-swatch-text">Green</span>
                                        </span>
                                    </a>
                                    <span class="rbt-color-swatch-count">(46)</span>
                                </li>
                                <li class="rbt-color-swatch-group">
                                    <a href="#" class="rbt-color-swatch-content">
                                        <span class="rbt-color-swatch">
                                            <span class="rbt-color-swatch-bg rbt-swatch-bg-orange"></span>
                                            <span class="rbt-color-swatch-text">Orange</span>
                                        </span>
                                    </a>
                                    <span class="rbt-color-swatch-count">(94)</span>
                                </li>
                                <li class="rbt-color-swatch-group">
                                    <a href="#" class="rbt-color-swatch-content">
                                        <span class="rbt-color-swatch">
                                            <span class="rbt-color-swatch-bg rbt-swatch-bg-red"></span>
                                            <span class="rbt-color-swatch-text">Red</span>
                                        </span>
                                    </a>
                                    <span class="rbt-color-swatch-count">(85)</span>
                                </li>
                                <li class="rbt-color-swatch-group">
                                    <a href="#" class="rbt-color-swatch-content">
                                        <span class="rbt-color-swatch">
                                            <span class="rbt-color-swatch-bg rbt-swatch-bg-yellow"></span>
                                            <span class="rbt-color-swatch-text">Yellow</span>
                                        </span>
                                    </a>
                                    <span class="rbt-color-swatch-count">(55)</span>
                                </li>
                                <li class="rbt-color-swatch-group">
                                    <a href="#" class="rbt-color-swatch-content">
                                        <span class="rbt-color-swatch">
            ...
            <div class="rbt-single-widget rbt-widget-categories">
                <div class="rbt-single-widget-inner">
                    ...
                    <div class="collapse show" id="rbt-collapse-9">
            ...
            <div class="rbt-single-widget rbt-widget-categories">
                <div class="rbt-single-widget-inner">
                    <h2 class="rbt-widget-title rbt-widget-title-without-border h4">
                        <a data-bs-toggle="collapse" href="#rbt-collapse-10" role="button" aria-expanded="false" aria-controls="rbt-collapse-10">
                            Promotion & Services
                            <span class="icon"><i class="fa-regular fa-chevron-down"></i></span>
                        </a>
                    </h2>
                    <div class="collapse show" id="rbt-collapse-10">
                        <div class="rbt-sidebar-list-wrapper rbt-tag-list justify-content-start pt--0">
                            <a href="#">Free Delivery <i class="fa-regular fa-truck-fast"></i></a>
                            <a href="#">Hot Deals <i class="fa-sharp fa-regular fa-stars"></i></a>
                            <a href="#">Authentic Brands <i class="fa-regular fa-badge-check"></i></a>
                            <a href="#">Cash On Delivery <i class="fa-regular fa-money-bill"></i></a>
                            <a href="#">Installment <i class="fa-sharp fa-regular fa-calendar-days"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            --}}
                ...
                <div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 col-12 mt--24 mt_sm--8 mt_md--8">
                    <div class="row row--12">
    <div class="col-md-12">
        <div class="rbt-shop-tools-wrapper">
            <div class="rbt-shop-tool-content rbt-shop-filter-tag-wrapper w-100">
                <p class="rbt-shop-tools-title h6">Fast FIlter :</p>
                <div class="rbt-shop-filter-tag-list rbt-tag-list rbt-tag-list-rounded rbt-tag-list-var-one">
                    <a href="#"><i class="fa-regular fa-truck-fast"></i> Featured</a>
                    <a href="#"><i class="fa-sharp fa-regular fa-stars"></i> Best Sellers</a>
                    <a href="#"><i class="fa-regular fa-badge-check"></i> Top Rated </a>
                    <a href="#"><i class="fa-regular fa-money-bill"></i> New</a>
                    <a href="#"><i class="fa-sharp fa-regular fa-calendar-days"></i> Top Items</a>
                    <a href="#"><i class="fa-sharp fa-regular fa-stars"></i> Popular Item</a>
                    <a href="#"><i class="fa-regular fa-badge-check"></i> Top Rated </a>
                    <a href="#"><i class="fa-regular fa-palette"></i> Best Colors</a>
                </div>
            </div>
        </div>
        {{--
        <div class="rbt-shop-tools-wrapper rbt-shop-tools-wrapper-var-one mt--20 mt_sm--12">
            <div class="rbt-shop-tool-content rbt-shop-view-var-wrapper sm_w-100 md_w-100">
                ...
                <div class="rbt-shop-view-btn-list rbt-tag-list-rounded rbt-shop-view-menu d-none d-lg-flex">
                ...
                <div class="rbt-shop-tools-title h3 rbt--text-color-heading d-flex w-100 justify-content-end d-lg-none">
                    <div class="rbt-modern-select rbt-shop-view-sort-select-one rbt-shop-sort-icon-only">
                        <select class="rbt-select-activation rbt-select-icon-only" aria-label="Sort products">
            ...
            <div class="rbt-shop-tool-content rbt-shop-view-sort-wrapper d-none d-lg-flex">
                <div class="rbt-tools-select-single">
                    <p class="rbt-shop-tools-title h6">Sort :</p>
                ...
                <div class="rbt-tools-select-single d-none d-lg-flex">
                    <p class="rbt-shop-tools-title h6">Show :</p>
            ...
            <div class="rbt-shop-tool-content rbt-shop-view-var-wrapper d-none d-lg-flex">
                <div class="rbt-inner-search-field style-one rbt-search-field-rounded">
                    <input type="text" placeholder="Search for products">
                    <button class="rbt-round-btn search-btn" type="submit" aria-label="Search"><i class="fa-solid fa-magnifying-glass"></i></button>
                </div>
            </div>
        ...
        <div class="rbt-shop-tools-wrapper mt--20 d-none d-lg-block">
            <div class="rbt-shop-tool-content rbt-shop-filter-tag-wrapper">
                <div class="rbt-shop-filter-tag-list rbt-tag-list rbt-tag-list-sm rbt-tag-list-bg-var-one rbt-tag-list-rounded rbt-tag-cancel-var">
                    <a href="#"><i class="fa-solid fa-xmark"></i> Featured</a>
                    <a href="#"><i class="fa-solid fa-xmark"></i> Best Products</a>
                    <a href="#"><i class="fa-solid fa-xmark"></i> Popular</a>
...
<div class="rbt-shop-tool-content rbt-shop-view-var-wrapper justify-content-between d-lg-none mt--16 mt_sm--12">
    <p class="rbt-shop-tools-title h6 rbt-text-color-heading">
        <a href="#" class="rbt-filter-offcanvas-activation rbt-filter-button">
            ...
            <div class="rbt-sidebar-widget-wrapper rbt-sidebar-bg-one position-relative">
                ...
                <div class="rbt-sidebar-bottom">
                    ...
                    <div class="rbt-single-widget rbt-widget-categories">
                        <div class="rbt-single-widget-inner">
                            <h2 class="rbt-widget-title rbt-widget-title-without-border h4">
                                <a data-bs-toggle="collapse" href="#rbt-collapse-4" role="button" aria-expanded="false" aria-controls="rbt-collapse-4">
                                    Filter by Size
                                    <span class="icon"><i class="fa-regular fa-chevron-down"></i></span>
                                </a>
                            </h2>
                            <div class="collapse show" id="rbt-collapse-4">
                                <ul class="rbt-sidebar-list-wrapper rbt-size-select-btn">
                                    <li class="rbt-check-group">
                                        <input id="rbt-prd-size-1" type="radio" name="rbt-prd-size">
                                        <label for="rbt-prd-size-1">
                                            <span>L</span>
                                        </label>
                                    </li>
                                    <li class="rbt-check-group">
                                        <input id="rbt-prd-size-2" type="radio" name="rbt-prd-size">
                                        <label for="rbt-prd-size-2">
                                            <span>M</span>
                                        </label>
                                    </li>
                                    <li class="rbt-check-group">
                                        <input id="rbt-prd-size-3" type="radio" name="rbt-prd-size">
                                        <label for="rbt-prd-size-3">
                                            <span>S</span>
                                        </label>
                                    </li>
                                    <li class="rbt-check-group">
                                        <input id="rbt-prd-size-4" type="radio" name="rbt-prd-size">
                                        <label for="rbt-prd-size-4">
                                            <span>XS</span>
                                        </label>
                                    </li>
                                    <li class="rbt-check-group">
                                        <input id="rbt-prd-size-5" type="radio" name="rbt-prd-size">
                                        <label for="rbt-prd-size-5">
                                            <span>XL</span>
                                        </label>
                                    </li>
                                </ul>
                    ...
                    <div class="rbt-single-widget rbt-widget-categories">
                        <div class="rbt-single-widget-inner">
                            <h2 class="rbt-widget-title rbt-widget-title-without-border h4">
                                <a data-bs-toggle="collapse" href="#rbt-collapse-5" role="button" aria-expanded="false" aria-controls="rbt-collapse-5">
                                    Categories
                                    <span class="icon"><i class="fa-regular fa-chevron-down"></i></span>
                                </a>
                            </h2>
                            <div class="collapse show" id="rbt-collapse-5">
                                <ul class="rbt-sidebar-list-wrapper rbt-categories-list-check">
                                    <li class="rbt-check-group">
                                        <input id="prd-status-1" type="checkbox" name="prd-status-1">
                                        <label for="prd-status-1">On sale <span class="rbt-lable count">(96)</span></label>
                                    </li>
                                    <li class="rbt-check-group">
                                        <input id="prd-status-2" type="checkbox" name="prd-status-2">
                                        <label for="prd-status-2">In stock <span class="rbt-lable count">(12)</span></label>
                                    </li>
                                    <li class="rbt-check-group">
                                        <input id="prd-status-3" type="checkbox" name="prd-status-3">
                                        <label for="prd-status-3">On backorder <span class="rbt-lable count">(67)</span></label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="rbt-single-widget-inner">
                    <h2 class="rbt-widget-title rbt-widget-title-without-border pb--0 h4">
                        <a data-bs-toggle="collapse" href="#rbt-collapse-8" role="button" aria-expanded="false" aria-controls="rbt-collapse-8">
                            ...
                            <div class="collapse show" id="rbt-collapse-8">
                                <div class="rbt-has-show-more">
                                    <span class="rbt-filter-item-not-found rbt-text-color-danger">Color not
                                        matched</span>
                                    <ul class="rbt-sidebar-list-wrapper rbt-categories-list-color-swatch rbt-search-filter-item-list rbt-has-show-more-inner-content">
                                        <li class="rbt-color-swatch-group">
                                            <a href="#" class="rbt-color-swatch-content">
...
<!-- <a class="close_side_menu" href="javascript:void(0);"></a> -->
                    <!-- Start Card Area -->
<div class="row row--12 mt_sm--8 mt_md--8">
    <!-- Start Single Card  -->
        ...
        <div class="rbt-card rbt-product-card has-hover-box-shadow">
            <div class="inner rbt-scroll-trigger fade_in animation-order-2">
                ...
                <div class="rbt-card-body">
                    ...
                    <div class="pricing-part">
                        <span class="price-text">Rs. 23.00 - Rs. 134.98</span>
        ...
        <div class="rbt-card rbt-product-card has-hover-box-shadow">
            <div class="inner rbt-scroll-trigger fade_in animation-order-3">
                ...
                <div class="rbt-card-body">
                    ...
                    <div class="pricing-part">
                        <span class="price-text">Rs. 99.98 - Rs. 384.98</span>
            ...
            <div class="inner rbt-scroll-trigger fade_in animation-order-1">
                ...
                <div class="rbt-card-body">
                    ...
                    <div class="pricing-part">
                        ...
                        <span class="price-text">Rs. 139.49</span>
        ...
        <div class="rbt-card rbt-product-card has-hover-box-shadow">
            <div class="inner rbt-scroll-trigger fade_in animation-order-4">
                ...
                <div class="rbt-card-body">
                    ...
                    <div class="pricing-part">
                        <del class="price-text">Rs. 295.00</del>
                        <span class="price-text">Rs. 189.59</span>
        ...
        <div class="rbt-card rbt-product-card has-hover-box-shadow">
            <div class="inner rbt-scroll-trigger fade_in animation-order-2">
                ...
                <div class="rbt-card-body">
                    ...
                    <div class="pricing-part">
                        <span class="price-text">Rs. 50.59 - Rs. 155.99</span>
                        <div class="rbt-badge rbt-badge-bg-green rbt-badge-border rbt-badge-small rbt-badge-rounded">9
                            in Stock</div>
                    </div>
                    <div class="prd-btn-grp">
        ...
        <div class="rbt-card rbt-product-card has-hover-box-shadow">
            <div class="inner rbt-scroll-trigger fade_in animation-order-1">
                ...
                <div class="rbt-card-body">
                    ...
                    <div class="pricing-part">
                        <del class="price-text">Rs. 295.00</del>
                        <span class="price-text">Rs. 189.79</span>
                        <span class="rbt-offer-badge">-30%</span>
                        <div class="rbt-badge rbt-badge-bg-green rbt-badge-border rbt-badge-small rbt-badge-rounded">12
                            in Stock</div>
                    </div>
        ...
        <div class="rbt-card rbt-product-card has-hover-box-shadow">
            <div class="inner rbt-scroll-trigger fade_in animation-order-2">
                ...
                <div class="rbt-card-body">
                    ...
                    <div class="pricing-part">
                        <span class="price-text">Rs. 46.00 - Rs. 189.98</span>
                        <div class="rbt-badge rbt-badge-bg-green rbt-badge-border rbt-badge-small rbt-badge-rounded">9
                            in Stock</div>
                    </div>
                    <div class="prd-btn-grp">
...
<!-- End Card Area -->
    ...
    <ul class="rbt-pagination">
        <li><a href="#!" aria-label="Previous"><i class="fa-regular fa-chevron-left"></i></a></li>
        <li><a href="#!">1</a></li>
        <li class="active"><a href="#!">2</a></li>
        <li><a href="#!">3</a></li>
        <li><a href="#!" aria-label="Next"><i class="fa-regular fa-chevron-right"></i></a></li>
    </ul>
</nav>
                        </div>
                    </div>
    ...
    <!-- Start notify Modal Area  -->
<div class="rbt-default-modal modal fade has-rbt-top-folder-shape" id="notifyModal" tabindex="-1" role="dialog" aria-modal="true" aria-labelledby="notifyModalLabel" aria-hidden="true">
                    ...
                    <div class="rbt-notify-modal-content">
                        ...
                        <div class="rbt-info-wrapper d-flex mt--8 rbt-gap--12">
                            <div class="rbt-info-box rbt-notify-box w-100">
                                ...
                                <div class="rbt-input-field-grp">
                                    <input class="rbt-input-field rbt-bg-color-white shadow-none plr--24" type="email" placeholder="Enter your e-mail">
                                </div>
                                <button class="rbt-btn rbt-btn-rounded w-100 mt--12">Notify Me</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <tr class="rbt-compare-prd-table-head">
            ...
            <td>
                <div class="rbt-compare-item-wrapper">
                    ...
                    <a href="product-single-default.html" class="rbt-product-item-img rbt-bg-color-brand-100 rbt-scroll-trigger fade_in animation-order-1">
                    ...
                    <div class="rbt-compare-values">
                        ...
                        <p class="rbt-product-item-title h6">
                            <a href="product-single-default.html">Apple AirPods (3rd Generation) with MagSafe</a>
                        </p>
            ...
            <td>
                <div class="rbt-compare-item-wrapper">
                    ...
                    <a href="product-single-default.html" class="rbt-product-item-img rbt-bg-color-brand-100 rbt-scroll-trigger fade_in animation-order-2">
                    ...
                    <div class="rbt-compare-values">
                        ...
                        <p class="rbt-product-item-title h6">
                            <a href="product-single-default.html">Samsung Galaxy Buds 2 Pro Wireless Earbuds</a>
                        </p>
                        <a class="rbt-btn rbt-btn-sm has-left-icon" href="#">
                            <i class="fa-regular fa-cart-shopping"></i>
                            Add To Cart
            ...
            <td>
                <div class="rbt-compare-item-wrapper">
                    ...
                    <a href="product-single-default.html" class="rbt-product-item-img rbt-bg-color-brand-100 rbt-scroll-trigger fade_in animation-order-3">
                    ...
                    <div class="rbt-compare-values">
                        ...
                        <p class="rbt-product-item-title h6">
                            <a href="product-single-default.html">Sony WF-1000XM5 Noise-Canceling Earbuds</a>
                        </p>
                        <a class="rbt-btn rbt-btn-sm has-left-icon" href="#">
                            <i class="fa-regular fa-cart-shopping"></i>
                            Add To Cart
            ...
            <td>
                <div class="rbt-compare-item-wrapper">
                    ...
                    <a href="product-single-default.html" class="rbt-product-item-img rbt-bg-color-brand-100 rbt-scroll-trigger fade_in animation-order-4">
                    ...
                    <div class="rbt-compare-values">
                        ...
                        <p class="rbt-product-item-title h6">
                            <a href="product-single-default.html">Apple AirPods Max Over-Ear Headphones</a>
                        </p>
                        <a class="rbt-btn rbt-btn-sm has-left-icon" href="#">
                            <i class="fa-regular fa-cart-shopping"></i>
                            Add To Cart
                ...
                <div class="rbt-bg-color-white rbt-content-trs-portion">
                    ...
                    <div class="rbt-social-share-wrapper">
                        ...
                        <ul class="social-icon rbt-social-default mt--16 mt_sm--0 rbt-social-default-v1 lg-size justify-content-start">
                            ...
                            <li>
                                <a class="email-btn" href="/cdn-cgi/l/email-protection#6e1d01030b01000b2e0b160f031e020b400d0103">
