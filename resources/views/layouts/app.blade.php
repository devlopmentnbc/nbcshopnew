...
<head>
    ...
    <meta name="description"
        content="Shop authentic herbal beauty and personal care products from Nature's Beauty Creations.">
    ...
    <link rel="preload" href="{{ asset('assets/fonts/fa-brands-400.woff2') }}" as="font" type="font/woff2"
        crossorigin="">
    <link rel="preload" href="{{ asset('assets/fonts/fa-regular-400.woff2') }}" as="font" type="font/woff2"
        crossorigin="">
    <link rel="preload" href="{{ asset('assets/fonts/fa-solid-900.woff2') }}" as="font" type="font/woff2"
        crossorigin="">
 ...
 ============================================ -->
    ...
    <link rel="preload" href="{{ asset('assets/css/plugins/fontawesome-all.min.css') }}" as="style"
...
<body class="rbt-header-sticky">
    <header class="rbt-header rbt-header-9">
        ...
        <div
            class="rbt-header-wrapper rbt-header-sticky-activation rbt-header-wrapper-three rbt-header-wrapper-one header-space-between header-not-transparent header-sticky plr--0 nbc-shop-header">
            <div
                class="rbt-header-campaign rbt-header-campaign-1 rbt-header-top-news rbt-topbar-bg-img rbt-topbar-bg-one">
                                        ...
                                        <div class="swiper-wrapper w-100">
                                            <div class="swiper-slide">
                                                <div class="rbt-fancy-item fancy-menu-text fancy-menu-start">
                                                    <p class="rbt-fancy-text rbt-text-color-white">Authentic NBC
                                                        products delivered islandwide.
                                                        <a class="rbt-text-color-white" href="{{ route('shop') }}">Shop
                                                            Now</a>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="rbt-fancy-item fancy-menu-text fancy-menu-start">
                                                    <p class="rbt-fancy-text rbt-text-color-white">Herbal beauty
                                                        inspired by nature since 1984.
                                                        <a class="rbt-text-color-white" href="{{ route('shop') }}">Shop
                                                            Now</a>
                                                    </p>
                                                </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="rbt-fancy-item fancy-menu-text fancy-menu-start">
                                                    <p class="rbt-fancy-text rbt-text-color-white">Discover special
                                                        online offers from NBC.
                                                        <a class="rbt-text-color-white" href="{{ route('shop') }}">Shop
                                                            Now</a>
                                                    </p>
                                                </div>
                    ...
                    <div class="mainbar-row @@navigationEnd align-items-center">
                        <div class="header-left">
                            <div class="rbt-header-content rbt-gap--32">
                                ...
                                <div class="header-info p-0 d-none rbt-category-update rbt-category-update-var-modern">
                                            ...
                                            <ul class="rbt-dropdown-parent-wrapper">
                                                <li class="dropdown-parent-list">
                                                    <a href="shop-by-categories.html">
                                                        <span><i class="fa-regular fa-house-chimney"></i></span>Home &
                                                        Garden
                                                        <span class="rbt-chevron-right"><i
                                                                class="fa-regular fa-chevron-right"></i></span>
                                                    </a>
                                                    <div
                                                        class="rbt-dropdown-child-wrapper rbt-dropdown-child-wrapper-lg ">
                                                                ...
                                                                <div class="rbt-megamenu-wrapper">
                                                                    <div class="row row--16">
                                                                        <div class="col-lg-6 col-xl-7 col-xxl-7">
                                                                            <div class="row row--16">
                                                                                <div
                                                                                    class="col-lg-6 col-xl-6 col-xxl-6 single-mega-item rbt-scroll-trigger fade_in animation-order-1">
                                                                                    <p class="rbt-short-title h5">Home
                                                                                        & Garden</p>
                                                                                    <ul class="mega-menu-item">
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Furniture</a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Living
                                                                                                Room Sets</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Sofas
                                                                                                & Couches</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Coffee
                                                                                                Tables</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Bedroom
                                                                                                Furniture</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Mattresses
                                                                                                & Bedding</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Wardrobes
                                                                                                & Storage</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                                <div
                                                                                    class="col-lg-6 col-xl-6 col-xxl-6 single-mega-item rbt-scroll-trigger fade_in animation-order-2">
                                                                                    <p class="rbt-short-title h5">More
                                                                                        Home & Garden</p>
                                                                                    <ul class="mega-menu-item">
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Home
                                                                                                Decor</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Clocks
                                                                                                & Mirrors</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Curtains
                                                                                                & Blinds</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Rugs
                                                                                                & Carpets</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Lighting
                                                                                                & Lamps</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Outdoor
                                                                                                Furniture</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">BBQ
                                                                                                & Grills</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                                <div class="col-lg-12">
                                                                                    <div
                                                                                        class="rbt-quick-info-tag d-flex mt--16">
                                                                        ...
                                                                        <div
                                                                            class="col-lg-6 col-xl-5 col-xxl-5 single-mega-item rbt-scroll-trigger fade_in animation-order-1">
                                                                            <div class="rbt-menu-offer-card">
                                                                                <div
                                                                                    class="mega-top-banner rbt-bg-color-extra-six">
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <h2 class="title">All For
                                                                                                Garden</h2>
                                                                                            <p class="b3 desc">Send
                                                                                                your idea, appear
                                                                                                Unimart.</p>
                                                                                        </div>
                                                ...
                                                <li class="dropdown-parent-list">
                                                    <a href="shop-by-categories.html"><span><i
                                                                class="fa-regular fa-mobile-notch"></i></span>Smart
                                                        Phones
                                                        <span class="rbt-chevron-right"><i
                                                                class="fa-regular fa-chevron-right"></i></span>
                                                    </a>
                                                                    ...
                                                                    <div class="row row--16">
                                                                        <div class="col-lg-6 col-xl-7 col-xxl-7">
                                                                            <div class="row row--16">
                                                                                <div
                                                                                    class="col-lg-6 col-xl-6 col-xxl-6 single-mega-item rbt-scroll-trigger fade_in animation-order-1">
                                                                                    <p class="rbt-short-title h5">Smart
                                                                                        Phones</p>
                                                                                    <ul class="mega-menu-item">
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Latest
                                                                                                Models</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">5G
                                                                                                Phones</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Android
                                                                                                Phones</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">iPhones</a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Gaming
                                                                                                Phones</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Budget
                                                                                                Phones</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Accessories</a>
                                                                                        </li>
                                                                                    </ul>
                                                                                </div>
                                                                                <div
                                                                                    ...
                                                                                    <ul class="mega-menu-item">
                                                                                        ...
                                                                                        <li><a
                                                                                                ...
                                                                                                Tablets</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">iPads</a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Tablet
                                                                                                Keyboards</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Stylus
                                                                                                Pens</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Screen
                                                                                                Protectors</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Tablet
                                                                                                Cases</a></li>
                                                                        ...
                                                                        <div
                                                                            class="col-lg-6 col-xl-5 col-xxl-5 single-mega-item rbt-scroll-trigger fade_in animation-order-1">
                                                                            <div
                                                                                class="rbt-menu-offer-card rbt-bg-style-box rbt-bg-two">
                                                                                <div class="mega-top-banner">
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            class="rbt-banner-content">
                                                                                            <h2
                                                                                                class="title rbt-text-color-white">
                                                                                                Apple 16 Pro</h2>
                                                                                            <p
                                                                                                class="b3 desc rbt-text-color-gray-200">
                                                                                                Send your idea,
                                                                                                appear Unimart.</p>
                                                                                        </div>
                                                                                        <a class="rbt-btn rbt-btn-sm"
                                                                                            href="#">View
                                                                                            Details</a>
                                                                                        <a href="#"
                                                                                            class="product-img position-bottom mt--24"><img
                                                ...
                                                <li class="dropdown-parent-list">
                                                    <a href="shop-by-categories.html">
                                                        <span><i class="fa-regular fa-desktop"></i></span>Electronics
                                                        Gadgets
                                                        <span class="rbt-chevron-right"><i
                                                                class="fa-regular fa-chevron-right"></i></span>
                                                    </a>
                                                                        ...
                                                                        <div class="col-lg-6 col-xl-7 col-xxl-7">
                                                                            <div class="row row--16">
                                                                                <div
                                                                                    ...
                                                                                    <ul class="mega-menu-item">
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Smartwatches</a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Fitness
                                                                                                Trackers</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">VR
                                                                                                & AR Headsets</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Smart
                                                                                                Glasses</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Sleep
                                                                                                Trackers</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Wearable
                                                                                                Cameras</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Wireless
                                                                                                Earbuds</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                                <div
                                                                                    ...
                                                                                    <ul class="mega-menu-item">
                                                                                        ...
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Streaming
                                                                                                Devices</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">External
                                                                                                Monitors</a></li>
                                                                                        <li><a
                                                                                                href="shop-by-category.html">Portable
                                                                                                Projectors</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                                <div class="col-lg-12">
                                                ...
                                                <li class="dropdown-parent-list">
                                                    <a href="shop-by-categories.html">
                                                        <span><i class="fa-regular fa-camera"></i></span>Cameras &
                                                        Photo
                                                    </a>
                                                </li>
                                                <li class="dropdown-parent-list">
                                                    <a href="shop-by-categories.html">
                                                        <span><i class="fa-regular fa-cauldron"></i></span>Cooking
                                                        Items
                                                    </a>
                                                </li>
                                                <li class="dropdown-parent-list">
                                                    <a href="shop-by-categories.html">
                                                        <span><i class="fa-regular fa-heart-pulse"></i></span>Health &
                                                        Beauty
                                                    </a>
                                                </li>
                                                <li class="dropdown-parent-list">
                                                    <a href="categories-list.html">
                                                        View All Categories <i
                                                            class="fa-regular fa-chevron-right ml--8"></i>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="header-info d-none d-xl-block ">
                                <nav class="rbt-mainmenu-nav">
                                    ...
                                    <ul class="mainmenu has-nav-bg-shape-hover nbc-mainmenu__legacy">
                                        <li
                                            class="with-rbt-megamenu has-menu-child-item position-static rbt-initial-odo-count">
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="inner">
                                                                        ...
                                                                        <div class="content">
                                                                            <h2 class="rbt-title h4"><a
                                                                                    href="home-fashion.html">Fashion
                                                                                    One</a></h2>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row row--0">
                                                        <div class="col-3 ">
                                                            <div class="rbt-menu-tab-wrapper">
                                                                <nav id="rbt-megamenuTab"
                                                                    class="nav nav-pills flex-column rbt-megamenu-tab rbt-megamenu-tab-cs-activation">
                                                                    <a href="#rbt-megamenu_tab1" data-bs-toggle="pill"
                                                                        class="active nav-link">
                                                                        <span><i
                                                                                class="fa-regular fa-store"></i></span>
                                                                        Shop Pages
                                                                        <span class="rbt-chevron-right"><i
                                                                                class="fa-regular fa-chevron-right"></i></span>
                                                                    </a>
                                                                    <a href="#rbt-megamenu_tab3" data-bs-toggle="pill"
                                                                        class="nav-link">
                                                                        <span><i
                                                                                class="fa-regular fa-shirt"></i></span>
                                                                        Single Product
                                                                        <span class="rbt-chevron-right"><i
                                                                                class="fa-regular fa-chevron-right"></i></span>
                                                                    </a>
                                                                    <a href="#rbt-megamenu_tab2" data-bs-toggle="pill"
                                                                        class="nav-link">
                                                                        <span><i
                                                                                class="fa-regular fa-swatchbook"></i></span>
                                                                        Products Variation
                                                                        <span class="rbt-chevron-right"><i
                                                                                class="fa-regular fa-chevron-right"></i></span>
                                                                    </a>
                                                                    <a href="#rbt-megamenu_tab4" data-bs-toggle="pill"
                                                                        class="nav-link">
                                                                        <span><i
                                                                                class="fa-regular fa-screwdriver-wrench"></i></span>
                                                                        Advance Features
                                                                        <span class="rbt-chevron-right"><i
                                                                                class="fa-regular fa-chevron-right"></i></span>
                                                                    </a>
                                                                    <a href="admin/index.htm" target="_blank"
                                                                        class="nav-link">
                                                                        <span><i
                                                                    ...
                                                                    <a href="#" class="nav-link disabled">
                                                                        <span><i
                                                                                class="fa-regular fa-shopping-bag"></i></span>
                                                                        Multivendor Shop
                                                                        <span
                                                                ...
                                                                <div class="rbt-tab-banner-img">
                                                                    <img src="{{ asset('assets/images/splash/menu-banner/menu-tab-banner-01.webp') }}"
                                                        ...
                                                        <div class="col-9">
                                                            <div class="rbt-menu-tab-content-wrapper">
                                                                <div class="tab-content rbt-megamenu-tab-content"
                                                                    id="megamenu-tab-content">
                                                                    <div class="tab-pane show active"
                                                                        id="rbt-megamenu_tab1">
                                                                        <div class="row row--24">
                                                                            <div class="col-xl-8">
                                                                                <div class="row row--8">
                                                                                    <div
                                                                                        class="col-xl-4 single-mega-item rbt-scroll-trigger fade_in animation-order-1">
                                                                                        <p class="rbt-short-title h5">
                                                                                            Shop Pages</p>
                                                                                        <ul class="mega-menu-item">
                                                                                            <li>
                                                                                            ...
                                                                                            <li><a
                                                                                                    href="shop-filter-list-left-sidebar.html">Shop
                                                                                                    List Left
                                                                                                    Sidebar</a></li>
                                                                                            <li><a
                                                                                                    href="shop-filter-list-right-sidebar.html">Shop
                                                                                                    List Right
                                                                                                    Sidebar</a></li>
                                                                                            <li><a
                                                                                            ...
                                                                                            <li><a
                                                                                                    href="shop-sticky-sidebar.html">Sticky
                                                                                                    Sidebar Shop
                                                                                                    <div
                                                                                                        class="rbt-product-badge rbt-product-badge-bg-primary border-rounded">
                                                                                                        NEW
                                                                                            ...
                                                                                            <li><a
                                                                                                    href="shop-collapsible-sidebar.html">Collapse
                                                                                                    Sidebar Shop</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="shop-scroll-sidebar.html">Scroll
                                                                                                    Sidebar Shop</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="shop-loadmore.html">Load
                                                                                                    More Button</a></li>
                                                                                            <li><a
                                                                                                    href="shop-sm-categories.html">Shop
                                                                                                    Small Categories</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="products-inside-border-column-shop.html">Bordered
                                                                                                    inside
                                                                                                    Products Shop</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="products-show-rating-shop.html">
                                                                                    ...
                                                                                    <div
                                                                                        class="col-xl-4 single-mega-item rbt-scroll-trigger fade_in animation-order-2">
                                                                                        <p class="rbt-short-title h5">
                                                                                            Custom Pages</p>
                                                                                        <ul class="mega-menu-item">
                                                                                            <li><a
                                                                                                    href="shop-filter-grid-two.html">Two
                                                                                                    Columns</a></li>
                                                                                            <li><a
                                                                                                    href="shop-filter-grid-three.html">Three
                                                                                                    Columns</a></li>
                                                                                            <li><a
                                                                                                    href="shop-filter-grid-four.html">Four
                                                                                                    Columns
                                                                                                    <div
                                                                                            ...
                                                                                            <li><a
                                                                                                    href="shop-wider.html">Three
                                                                                                    Columns Wide</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="shop-wider-four.html">
                                                                                                    Four Columns
                                                                                                    <div
                                                                                            ...
                                                                                            <li><a
                                                                                                    href="shop-wider-five.html">Five
                                                                                                    Columns Wide</a>
                                                                                            </li>

                                                                                            <li><a
                                                                                                    href="shop-wider-six.html">Six
                                                                                                    Columns Wide</a>
                                                                                            </li>

                                                                                            <li><a
                                                                                                    href="shop-featured.html">Featured
                                                                                                    Products</a></li>
                                                                                            <li><a
                                                                                                    href="shop-best-prds.html">Best
                                                                                                    Selling Products</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="shop-collapse-filter-top.html">Hidden
                                                                                                    Side Bar Shop</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="products-show-countdown-shop-style-two.html">Products
                                                                                                    Show
                                                                                                    Countdown Two</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="products-even-list-shop.html">Even
                                                                                                    List Products</a>
                                                                                            </li>
                                                                                        </ul>
                                                                                    </div>
                                                                                    <div
                                                                                        class="col-xl-4 single-mega-item rbt-scroll-trigger fade_in animation-order-3">
                                                                                        <p class="rbt-short-title h5">
                                                                                            Custom Pages</p>
                                                                                        <ul class="mega-menu-item">
                                                                                            <li><a
                                                                                                    href="shop-no-page-heading.html">Shop
                                                                                                    No Page Heading</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="shop-only-category.html">Shop
                                                                                                    Only Category</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="shop-offcanvas-sidebar-left.html">Shop
                                                                                                    offcanvas Left</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="shop-offcanvas-sidebar-right.html">Shop
                                                                                                    offcanvas Right</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="shop-offcanvas-sidebar-top.html">Shop
                                                                                                    offcanvas top</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="shop-offcanvas-sidebar-bottom.html">Shop
                                                                                                    offcanvas
                                                                                                    Bottom</a></li>
                                                                                            <li><a
                                                                                                    href="shop-collapse-filter-bottom.html">Shop
                                                                                                    Filter Collapse
                                                                                                    Bottom</a></li>
                                                                                            <li><a
                                                                                                    href="shop-collapse-filter-left.html">Shop
                                                                                                    Filter Collapse
                                                                                                    Left</a></li>
                                                                                            <li><a
                                                                                                    href="shop-collapse-filter-right.html">Shop
                                                                                                    Filter Collapse
                                                                                                    Right</a></li>
                                                                                            <li><a
                                                                                                    href="products-show-progressbar-shop.html">Products
                                                                                                    Show
                                                                                                    Progress-bar</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="products-show-countdown-shop.html">Products
                                                                                                    Show
                                                                                                    Countdown</a></li>
                                                                                            <li><a href="#!">Infinite
                                                                                                    Scroll
                                                                            ...
                                                                            <div
                                                                                class="col-xl-4 rbt-scroll-trigger fade_in animation-order-4">
                                                                                <div
                                                                                    class="rbt-menu-offer-card rbt-bg-style-box rbt-bg-three h-100 min-h-500">
                                                                                    <div
                                                                                        class="mega-top-banner h-100 align-items-start justify-content-center">
                                                                                        <div
                                                                                            class="rbt-banner-inner rbt-banner-inner-black flex-column rbt-gap--16 align-items-center text-center">
                                                                                            <div
                                                                                                class="rbt-banner-content">
                                                                                                <p
                                                                                                    class="b4 subtitle mb--0">
                                                                                                    Embrace comfy wear
                                                                                                </p>
                                                                                                <h2 class="h5 mb--4">
                                                                                                    Ready to fall in
                                                                                            ...
                                                                                            <a class="rbt-btn rbt-bg-color-secondary rbt-btn-sm"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="row row--24">
                                                                                <div class="col-xl-3 single-mega-item">
                                                                                    <p class="rbt-short-title h5">Page
                                                                                        Design</p>
                                                                                    <ul class="mega-menu-item">
                                                                                        <li><a
                                                                                                href="product-single-default.html">Product
                                                                                                Single Default</a></li>
                                                                                        <li><a
                                                                                                href="product-single-fashion.html">Product
                                                                                                Single Fashion<div
                                                                                                    class="rbt-product-badge rbt-product-badge-bg-danger border-rounded ml--8">
                                                                                                    TOP
                                                                                                </div></a></li>
                                                                                        <li><a
                                                                                                href="product-single-furniture.html">Product
                                                                                                Single Furniture</a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="product-single-cosmetic-beauty.html">Product
                                                                                                Single Beauty
                                                                                                Product</a></li>
                                                                                        <li><a
                                                                                                href="product-single-phone-case.html">Product
                                                                                                Single Phone Case</a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="product-single-accessories.html">Product
                                                                                                Single Accessories</a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="product-single-tech-accessories.html">Product
                                                                                                Single Tech
                                                                                                Accessories</a></li>
                                                                                        <li><a
                                                                                                href="product-single-animal-accessories.html">Product
                                                                                                Single Animal
                                                                                                Accessories</a></li>
                                                                                        <li><a
                                                                                                href="product-single-ladies-bag.html">Product
                                                                                                Ladies Bag</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                                <div class="col-xl-3 single-mega-item">
                                                                                    ...
                                                                                    <ul class="mega-menu-item">
                                                                                        <li><a
                                                                                                href="product-single-laggage-bag.html">Product
                                                                                                Single Laggage Bag</a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="product-single-printing-service.html">Product
                                                                                                Single Print
                                                                                                Product</a></li>
                                                                                        <li><a
                                                                                                href="product-single-sports-shoe.html">Product
                                                                                                Keds
                                                                                                <div
                                                                                                    class="rbt-product-badge rbt-product-badge-bg-green border-rounded ml--8">
                                                                                                    POPULAR
                                                                                        ...
                                                                                        <li><a
                                                                                                href="product-single-accessories-two.html">Product
                                                                                                Single Accessories
                                                                                                Two</a></li>
                                                                                        <li><a
                                                                                                href="product-single-gallary-two-v360.html">Product
                                                                                                Single 360 Angle
                                                                                                View
                                                                                            </a></li>
                                                                                        <li><a
                                                                                                href="product-single-gallary.html">Product
                                                                                                Grid Gallary
                                                                                            </a></li>
                                                                                        <li><a
                                                                                                href="product-single-gallary-two.html">Product
                                                                                                Grid Gallary
                                                                                                Two</a></li>
                                                                                        <li><a href="#!">Product
                                                                                                Classic
                                                                                ...
                                                                                <div class="col-xl-3 single-mega-item">
                                                                                    ...
                                                                                    <ul class="mega-menu-item">
                                                                                        <li><a
                                                                                                href="product-single-sticky-info.html">Product
                                                                                                Single Sticky Info</a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="product-single-sticky-info-both.html">Product
                                                                                                Single Sticky
                                                                                                Info Both</a></li>
                                                                                        <li><a
                                                                                                href="product-single-sticky-thumb.html">Product
                                                                                                Single Thumb
                                                                                                sticky</a></li>
                                                                                        <li><a
                                                                                                href="product-single-gallary-side-view.html">Product
                                                                                                Single Side
                                                                                                View</a></li>
                                                                                        <li><a
                                                                                                href="product-single-stock-out.html">Product
                                                                                                Single Out of Stock</a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="product-single-with-buy-more-option.html">Product
                                                                                                Single with
                                                                                                Buy More Option</a></li>
                                                                                        <li><a
                                                                                                href="product-single-with-buy-more-option2.html">Product
                                                                                                Single with
                                                                                                Buy More Option Style
                                                                                                2</a></li>
                                                                                        <li><a href="#!">Product
                                                                                                Cross-Sell
                                                                                                <div
                                                                                ...
                                                                                <div class="col-xl-3 single-mega-item">
                                                                                    ...
                                                                                    <ul class="mega-menu-item">
                                                                                        <li><a
                                                                                                href="product-single-grid.html">Product
                                                                                                Grid
                                                                                                <div
                                                                                                    class="rbt-product-badge rbt-product-badge-bg-red border-rounded ml--8">
                                                                                                    Trending
                                                                                                </div>
                                                                                            </a></li>
                                                                                        <li><a
                                                                                                href="product-single-grid-sidebar.html">Product
                                                                                                Grid With Sidebar</a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="product-single-masonary.html">Product
                                                                                                Single Masonary</a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="product-single-gallary-side-view-two.html">Product
                                                                                                Single Side
                                                                                                View Two</a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="product-single-gallary-side-view-three.html">Product
                                                                                                Single
                                                                                                Side View Three</a></li>
                                                                                        <li><a
                                                                                                href="product-single-gallary-side-view-four.html">Product
                                                                                                Single Side
                                                                                                View Four</a></li>
                                                                                        <li><a
                                                                                                href="product-single-gallary-two-zoom-v1.html">Product
                                                                                                Single
                                                                                                Zoom01</a></li>
                                                                                        <li><a
                                                                                                href="product-single-gallary-two-zoom-v2.html">Product
                                                                                                Single
                                                                                                Zoom02</a></li>
                                                                                        <li><a
                                                                                                href="product-single-gallary-two-zoom-v3.html">Product
                                                                                                Single
                                                                                                Zoom03</a></li>
                                                                                        <li><a href="#!">Product
                                                                                                AR Preview
                                                                            ...
                                                                            <div class="row row--24">
                                                                                ...
                                                                                <div class="col-lg-12">
                                                                                    <div
                                                                                        class="swiper rbt-sm-review-card-swiper-activation-1 rbt-arrow-between has-right-bg-shape has-right-bg-shape-sm-width rbt-arrow-show-dfl">
                                                                                        <div class="swiper-wrapper">
                                                                                            <div class="swiper-slide">
                                                                                                <div
                                                                                                    class="rbt-sm-review-card">
                                                                                                    <div
                                                                                                        class="rbt-sm-review-card">
                                                                                                        <div
                                                                                                            class="rbt-avatar-img-wrapper">
                                                                                                            <div
                                                                                                                class="rbt-avatar-img">
                                                                                                                <img src="{{ asset('assets/images/reviewer-img/avater-sm-01.webp') }}"
                                                                                                                    alt="Eccommerce Client Image">
                                                                                                            </div>
                                                                                                            <span
                                                                                                                class="rbt-avarter-authintication-icon"><i
                                                                                                                    class="fa-solid fa-shield-check"></i></span>
                                                                                                        </div>
                                                                                                        <div
                                                                                                            class="rbt-avater-content-wrapper">
                                                                                                            <span
                                                                                                                class="title">Went
                                                                                                                above &
                                                                                                                beyond</span>
                                                                                                            <div
                                                                                                                ...
                                                                                                                <ul
                                                                                                                    class="rbt-rating-icon-list">
                                                                                                                    <li><i
                                                                                                                            class="fa-solid fa-star rbt-rated-icon"></i>
                                                                                                                    </li>
                                                                                                                    <li><i
                                                                                                                            class="fa-solid fa-star rbt-rated-icon"></i>
                                                                                                                    </li>
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                class="rbt-avatar-img">
                                                                                                                <img src="{{ asset('assets/images/reviewer-img/avater-sm-02.webp') }}"
                                                                                                                    alt="Eccommerce Client Image">
                                                                                                            </div>
                                                                                                            <span
                                                                                                                class="rbt-avarter-authintication-icon"><i
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                class="rbt-avatar-img">
                                                                                                                <img src="{{ asset('assets/images/reviewer-img/avater-sm-03.webp') }}"
                                                                                                                    alt="Eccommerce Client Image">
                                                                                                            </div>
                                                                                                            <span
                                                                                                                class="rbt-avarter-authintication-icon"><i
                                                                                        ...
                                                                                        <div
                                                                                            class="rbt-swiper-arrow rbt-arrow-right rbt-arrow-gray">
                                                                                            <div
                                                                                                class="custom-overflow">
                                                                                                <i
                                                                                                    class="rbt-icon fa-regular fa-arrow-right"></i>
                                                                                                <i
                                                                                                    class="rbt-icon-top fa-regular fa-arrow-right"></i>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="tab-pane fade" id="rbt-megamenu_tab2">
                                                                        <div class="row row--24">
                                                                            <div class="col-xl-8">
                                                                                <div class="row row--8">
                                                                                    <div
                                                                                        class="col-xl-4 single-mega-item">
                                                                                        <p class="rbt-short-title h5">
                                                                                            Hover Styles</p>
                                                                                        <ul class="mega-menu-item">
                                                                                            <li><a
                                                                                                    href="products-all-info-shop.html">All
                                                                                                    Info Products</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="products-scale-hover-shop.html">Transform
                                                                                                    Style One</a>
                                                                                            </li>
                                                                                            <li>
                                                                                                <a
                                                                                                    href="products-hover-add-tocart-shop.html">
                                                                                                    Hover Add to Cart
                                                                                                    <div
                                                                                            ...
                                                                                            <li><a
                                                                                                    href="products-standard-shop.html">Standard
                                                                                                    Products Shop</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="products-icons-hover-shop.html">Transform
                                                                                                    Style Two</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="products-button-onimage-shop.html">Transform
                                                                                                    Style
                                                                                                    Three</a></li>
                                                                                            <li><a
                                                                                                    href="products-additional-info-shop.html">Hover
                                                                                                    Additional
                                                                                                    Info</a></li>
                                                                                            <li><a
                                                                                                    href="products-button-visible-hover-shop.html">Transform
                                                                                                    Style
                                                                                                    Four</a></li>
                                                                                            <li><a
                                                                                                    href="products-shadow-hover-shop.html">Shadow
                                                                                                    Products Shop
                                                                                                    <div
                                                                                                        class="rbt-product-badge rbt-product-badge-bg-green border-rounded">
                                                                                                        POPULAR
                                                                                            ...
                                                                                            <li><a
                                                                                                    href="products-small-variation-shop.html">Products
                                                                                                    Small Size</a>
                                                                                            </li>
                                                                                        </ul>
                                                                                    </div>
                                                                                    <div
                                                                                        ...
                                                                                        <ul class="mega-menu-item">
                                                                                            ...
                                                                                            <li><a
                                                                                                    href="products-even-grid.html">Even
                                                                                                    Grid Products</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="products-border-column-shop.html">Bordered
                                                                                                    Products
                                                                                                    Shop</a></li>
                                                                                            <li><a
                                                                                                    href="products-inside-border-column-shop.html">Bordered
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <ul class="mega-menu-item">
                                                                                            <li><a
                                                                                                    href="categories-style-circle.html">Catagories
                                                                                                    Style Circle</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="categories-style-round-box.html">Catagories
                                                                                                    Style Round
                                                                                                    Box</a></li>
                                                                                            <li><a
                                                                                                    href="categories-style-button-circle.html">Catagories
                                                                                                    Style
                                                                                                    Button Circle</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="categories-style-simple-box.html">Catagories
                                                                                                    Style Simple
                                                                                                    Box</a></li>
                                                                                            <li><a
                                                                                                    href="categories-style-bento-box.html">Catagories
                                                                                                    Style Bento
                                                                                                    Box</a></li>
                                                                                            <li><a
                                                                                                    href="categories-style-linked-box.html">Catagories
                                                                                                    Style Linked
                                                                                                    Box</a></li>
                                                                                            <li><a
                                                                                                    href="categories-style-linked-box-swiper.html">Catagories
                                                                                                    Linked Swiper</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="categories-style-button-boxed.html">Catagories
                                                                                                    Button
                                                                                                    Boxed</a></li>
                                                                                            <li><a
                                                                                                    href="categories-style-classic-bento.html">Catagories
                                                                                                    Classic Bento </a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="categories-style-mini-bento.html">Catagories
                                                                                                    Mini
                                                                                                    Bento </a></li>
                                                                                        </ul>
                                                                                    </div>
                                                                                    <hr
                                                                                        class="rbt-separator rbt-separator-gray200 mb--16 mt--24 mt_sm--12 mb_sm--12 rbt-bg-color-gray-100">
                                                                                    <div class="col-lg-12">
                                                                                        <ul
                                                                                            class="rbt-nav-brand-list liststyle d-flex justify-content-between">
                                                                                            <li><a
                                                                                                    href="shop-by-brands.html"><img
                                                                            ...
                                                                            <div class="col-xl-4">
                                                                                <div
                                                                                    class="rbt-menu-offer-card rbt-bg-style-box rbt-bg-four h-100">
                                                                                    <div
                                                                                        class="mega-top-banner h-100 align-items-end justify-content-start">
                                                                                        <div
                                                                                            class="rbt-banner-inner rbt-banner-inner-black flex-column rbt-gap--16 align-items-start text-left">
                                                                                            <div
                                                                                                class="rbt-banner-content">
                                                                                                <p
                                                                                                    class="b4 subtitle rbt-text-color-white mb--0">
                                                                                                    Embrace comfy wear
                                                                                                </p>
                                                                                                <h2
                                                                                                    class="h5 mt--4 mb--0 rbt-text-color-white">
                                                                                                    Ready to fall in
                                                                                                    love
                                                                                                    with Autumn
                                                                                                    collection!</h2>
                                                                        ...
                                                                        <div class="row row--24">
                                                                            <div class="col-xl-8">
                                                                                <div class="row row--8">
                                                                                    <div
                                                                                        ...
                                                                                        <ul class="mega-menu-item">
                                                                                            <li><a
                                                                                                    href="feature-sticky-nav.html">Sticky
                                                                                                    navigation</a></li>
                                                                                            <li><a
                                                                                                    href="feature-frequently-baught-together.html">Frequently
                                                                                                    bought
                                                                                                    together</a></li>
                                                                                            <li><a
                                                                                                    href="feature-catalog-mode.html">Catalog
                                                                                                    mode Shop</a></li>
                                                                                            <li><a
                                                                                                    href="feature-mobile-bottom-nav.html">Mobile
                                                                                                    Bottom Navbar</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="feature-sign-in-btn.html">Sign
                                                                                                    In to Prices</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="shop-collapsible-sidebar.html">Shop
                                                                                                    Sidebar widgets
                                                                                                    Collapse</a></li>
                                                                                            <li><a
                                                                                                    href="feature-image-slider.html">Image
                                                                                                    Slider</a></li>
                                                                                            <li><a
                                                                                                    href="feature-sticky-nav.html">Sticky
                                                                                                    navigation</a></li>
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <ul class="mega-menu-item">
                                                                                            <li><a
                                                                                                    href="feature-all-image-shop.html">All
                                                                                                    Images on Shop</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="feature-size-guide.html">Size
                                                                                                    Guides PopUp</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="feature-product-single-gallary-v360.html">Product
                                                                                                    360
                                                                                                    view</a></li>
                                                                                            <li><a
                                                                                                    href="feature-product-vedio.html">Product
                                                                                                    Video
                                                                                                    <div
                                                                                                        class="rbt-product-badge rbt-product-badge-bg-danger border-rounded">
                                                                                                        HOT
                                                                                            ...
                                                                                            <li><a
                                                                                                    href="feature-special-offer-banner.html">Product
                                                                                                    Special
                                                                                                    Video</a></li>
                                                                                            <li><a
                                                                                                    href="feature-product-stock-progressbar.html">Product
                                                                                                    Stock
                                                                                                    ProgressBar</a></li>
                                                                                            <li><a
                                                                                                    href="feature-product-custom-design-uploder.html">Product
                                                                                                    Custom
                                                                                                    Design Uploader</a>
                                                                                            </li>
                                                                                            <li><a
                                                                                                    href="feature-product-single-full-width.html">FullWidth
                                                                                                    Product
                                                                                                    Single</a></li>
                                                                                            <li><a
                                                                                                    href="feature-mobile-bottom-nav.html">Mobile
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <ul class="mega-menu-item">
                                                                                            ...
                                                                                            <li><a
                                                                                                    href="checkout-payment.html">Checkout
                                                                                                    Payment</a></li>
                                                                                            <li><a
                                                                                                    href="checkout-shipping.html">Checkout
                                                                                                    Shipping</a></li>
                                                                                            <li><a
                                                                                                    href="checkout-thankyou.html">Thank
                                                                                                    You</a></li>
                                                                                            <li><a
                                                                                                    href="my-order-history.html">Order
                                                                                                    History</a></li>
                                                                                            <li><a
                                                                                                    href="my-reviews.html">My
                                                                                                    Reviews</a></li>
                                                                                            <li><a href="#!">Order
                                                                                                    Tracking
                                                                                                    <div
                                                                            ...
                                                                            <div class="col-xl-4">
                                                                                <div class="rbt-swiper-container">
                                                                                    <div
                                                                                        class="swiper rbt-megamenu-prd-card-activation-1 pb--24">
                                                                                        <div class="swiper-wrapper">
                                                                                            <!-- Start single card -->
                                                                                            <div class="swiper-slide">
                                                                                                <div
                                                                                                    class="rbt-card rbt-product-card">
                                                                                                    <div
                                                                                                        class="rbt-card-img rbt-bg-color-default">
                                                                                                        <a
                                                                                                            href="product-single-default.html">
                                                                                                            <img class="rbt-prd-img"
                                                                                                                src="{{ asset('assets/images/product-img/fashion/product-new-shoe-01-a-1.webp') }}"
                                                                                                                alt="Card Image">
                                                                                                        </a>
                                                                                                        <div
                                                                                                            class="rbt-badge-wrapper rbt-content-top-left">
                                                                                                            <div
                                                                                                                class="rbt-product-badge rbt-product-badge-bg-secondary">
                                                                                                                SALE
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div
                                                                                                            class="rbt-quick-btn-grp has-mixup-midlayer rbt-top-right--position hover-variation-one">
                                                                                                            <button
                                                                                                                class="rbt-wishlisted-btn bg-light-one rbt-quick-btn tooltips"
                                                                                                                type="button"
                                                                                                                data-tooltip="Add to wishlist"
                                                                                                                data-tooltip-position="left"><i
                                                                                                                    class="fa-regular fa-heart"></i></button>
                                                                                                            <button
                                                                                                                class="rbt-watch-btn bg-light-one rbt-quick-btn tooltips"
                                                                                                        ...
                                                                                                        <a class="rbt-btn hover-appear-element bottom-position text-center rbt-btn-sm rbt-square-btn d-block has-left-icon"
                                                                                                            href="#!"
                                                                                                            data-bs-toggle="modal"
                                                                                                            data-bs-target="#quickviewModal">Select
                                                                                                            Option</a>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="rbt-card-body rbt-card-body-center-align">
                                                                                                        <div
                                                                                                            class="rbt-color-select-area justify-content-center">
                                                                                                            <ul
                                                                                                                class="rbt-switcher-color-list product-switcher-activation">
                                                                                                                <li
                                                                                                                    class="active">
                                                                                                                    <a class="rbt-switcher--color tooltips"
                                                                                                                        data-switcher-color="#C64B3E"
                                                                                                                        data-src="{{ asset('assets/images/product-img/fashion/product-new-shoe-01-a-1.webp') }}"
                                                                                                                        data-tooltip="Orange"
                                                                                                                        data-tooltip-position="top"
                                                                                                                        href="#">
                                                                                                                        <div
                                                                                                                            class="rbt-color-circle">
                                                                                                                        </div>
                                                                                                                    </a>
                                                                                                                </li>
                                                                                                                <li><a class="rbt-switcher--color tooltips "
                                                                                                                        data-switcher-color="#DBC1A8"
                                                                                                                        data-src="{{ asset('assets/images/product-img/fashion/product-new-shoe-01-a-2.webp') }}"
                                                                                                                        data-tooltip="Golden"
                                                                                                                        data-tooltip-position="top"
                                                                                                                        href="#">
                                                                                                                        <div
                                                                                                                ...
                                                                                                                <li><a class="rbt-switcher--color tooltips"
                                                                                                                        data-switcher-color="#E8E0BE"
                                                                                                                        data-src="{{ asset('assets/images/product-img/fashion/product-new-shoe-01-a-3.webp') }}"
                                                                                                                        data-tooltip="Royel Green"
                                                                                                                        data-tooltip-position="top"
                                                                                                                        href="#">
                                                                                                                        <div
                                                                                                                            class="rbt-color-circle">
                                                                                                        ...
                                                                                                        <p
                                                                                                            ...
                                                                                                            <a
                                                                                                                href="product-single-default.html">Adidas
                                                                                                                Ultraboost
                                                                                                                Cream
                                                                                                                Color
                                                                                                                Shoe</a>
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <a
                                                                                                            href="product-single-default.html">
                                                                                                            <img class="rbt-prd-img"
                                                                                                                src="{{ asset('assets/images/product-img/fashion/product-new-shoe-01-a-2.webp') }}"
                                                                                                                alt="Card Image">
                                                                                                        </a>
                                                                                                        <div
                                                                                                            class="rbt-badge-wrapper rbt-content-top-left">
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <a
                                                                                                            href="product-single-default.html">
                                                                                                            <img class="rbt-prd-img"
                                                                                                                src="{{ asset('assets/images/product-img/fashion/product-new-shoe-01-a-3.webp') }}"
                                                                                                                alt="Card Image">
                                                                                                        </a>
                                                                                                        <div
                                                                                                            class="rbt-badge-wrapper rbt-content-top-left">
                                                                                        ...
                                                                                        <!-- pagination -->
                                                                                        <div
                                                                                            class="rbt-swiper-pagination-center">
                                                                                            <div
                                                                                                class="rbt-swiper-pagination rbt-swiper-pagination-var-one rbt-swiper-pagination-cente">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                        ...
                                        <li class="with-rbt-megamenu has-menu-child-item position-static">
                                            ...
                                            <!-- Start Mega Menu  -->
                                            <div
                                                class="rbt-megamenu rbt-width-fullscreen mega-has-bg-img mega-bg-one p-0 ">
                                                <!-- Start Mega Menu  -->
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="row">
                                                                        <div
                                                                            ...
                                                                            <p class="rbt-short-title h5">Inner Pages
                                                                            </p>
                                                                            <ul class="mega-menu-item">
                                                                                ...
                                                                                <li><a href="about.html">About Us
                                                                                        One</a></li>
                                                                                <li><a href="faq-page-01.html">FAQs
                                                                                        One</a></li>
                                                                                <li><a href="contact-two.html">Contact
                                                                                        Page Two</a></li>
                                                                                <li><a href="about-two.html">About Us
                                                                                        Two</a></li>
                                                                                <li><a href="contact-four.html">Contact
                                                                                        Page Four</a></li>
                                                                                <li><a href="faq-page-02.html">FAQs
                                                                                        Two</a></li>
                                                                        ...
                                                                        <div
                                                                            class="col-12 col-lg-1-5 single-mega-item rbt-scroll-trigger fade_in animation-order-1 mt--16">
                                                                            <p class="rbt-short-title h5">Shop User
                                                                                Pages</p>
                                                                            <ul class="mega-menu-item">
                                                                                ...
                                                                                <li><a href="help-center.html">User
                                                                                        Help Center</a></li>
                                                                                <li><a href="terms-policy.html">Terms
                                                                                        and conditions</a></li>
                                                                        ...
                                                                        <div
                                                                            class="col-12 col-lg-1-5 single-mega-item rbt-scroll-trigger fade_in animation-order-1 mt--16">
                                                                            <p class="rbt-short-title h5">E-commerce
                                                                            </p>
                                                                            <ul class="mega-menu-item">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="row row--12">
                                                                    <div
                                                                        ...
                                                                        <p class="rbt-short-title h5">Base Elements
                                                                        </p>
                                                                        <ul class="mega-menu-item">
                                                                    ...
                                                                    <div
                                                                        class="col-xl-3 single-mega-item rbt-scroll-trigger fade_in animation-order-1">
                                                                        <p class="rbt-short-title h5">Template
                                                                            Elements</p>
                                                                        <ul class="mega-menu-item">
                                                                            <li><a href="element-hotspot-styles.html">Hotspot
                                                                                    Styles</a></li>
                                                                            <li><a
                                                                                    href="element-countdown-styles.html">Countdown
                                                                                    Styles</a></li>
                                                                            <li><a href="element-insta-post.html">Instagram
                                                                                    Posts</a></li>
                                                                            <li><a href="element-products.html">Product
                                                                                    Card Styles</a></li>
                                                                            <li><a
                                                                                    href="element-catagories-style.html">Catagories
                                                                                    Card Styles</a></li>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="mega-menu-item">
                                                                            ...
                                                                            <li><a href="element-image-gallary.html">Image
                                                                                    Gallary</a></li>
                                                                            <li><a href="element-team-styles.html">Team
                                                                                    Card Styles</a></li>
                                                                            <li><a
                                                                                    href="element-accordion-styles.html">Accordion
                                                                                    Styles</a></li>
                                                                            <li><a
                                                                                    href="element-portfolio-styles.html">PortFolio
                                                                                    Card Styles</a></li>
                                                                            <li><a href="element-blog-styles.html">Blog
                                                                                    Card Styles</a></li>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="mega-menu-item">
                                                                            <li><a
                                                                                    href="element-recent-products.html">Recent
                                                                                    Products</a></li>
                                                                            <li><a
                                                                                    href="element-featured-products.html">Featured
                                                                                    Products</a></li>
                                                                            <li><a
                                                                            ...
                                                                            <li><a href="element-pricing.html">Pricing
                                                                                    Styles</a></li>
                                                                            <li><a href="element-cart.html">Cart
                                                                                    Styles</a></li>
                                                                ...
                                                                <div class="mega-top-banner">
                                                                    <div
                                                                        ...
                                                                        <div class="rbt-banner-content">
                                                                            <h2 class="title rbt-text-color-white">New
                                                                                Aurora Watch</h2>
                                                                            <p
                                                                                class="b3 desc rbt-text-color-gray-200">
                                                                                Send your idea, appear Unimart.</p>
                                                                        </div>
                                                                        <a class="rbt-btn rbt-btn-sm"
                                                                            href="#">View Details</a>
                                                                        <a href="#"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="row row-12 mt_dec--16">
                                                                        <div
                                                                            ...
                                                                            <p class="rbt-short-title h5">Ultimate
                                                                                User Experience</p>
                                                                            <ul class="mega-menu-item">
                                                                                <li><a href="customize-options.html">Easy
                                                                                        to Customize Codes</a></li>
                                                                                <li><a
                                                                                        href="page-customizability.html">Highly
                                                                                ...
                                                                                <li><a href="popup-builder.html">Popup
                                                                                        & Sidebar Search</a></li>
                                                                                <li><a href="boost-features.html">All
                                                                        ...
                                                                        <div
                                                                            class="col-12 col-xl-4 single-mega-item rbt-scroll-trigger fade_in animation-order-1 mt--16">
                                                                            <p class="rbt-short-title h5">Flexible
                                                                                Shopping</p>
                                                                            <ul class="mega-menu-item">
                                                                                ...
                                                                                <li><a
                                                                                        href="compare-table-builder.html">Product
                                                                                        Compare</a></li>
                                                                                <li><a href="wishlist-builder.html">WishLists
                                                                                        Builder</a></li>
                                                                                <li><a href="quick-view.html">Quick
                                                                                        View</a></li>
                                                                                <li><a
                                                                                        href="flash-sell-management.html">Flash
                                                                                        Sales Management</a></li>
                                                                                <li><a href="cart-builder.html">Cart
                                                                                        Upsell
                                                                                        <div
                                                                                            class="rbt-product-badge rbt-product-badge-bg-primary border-rounded">
                                                                                            New
                                                                                ...
                                                                                <li><a
                                                                                        href="sticky-cart-builder.html">Sticky
                                                                                        Add To Cart</a></li>
                                                                                <li><a href="product-display.html">Product
                                                                                        Video & 3D View</a></li>
                                                                                <li><a
                                                                                        href="multi-step-checkout.html">Multi-Step
                                                                                        Checkout</a></li>
                                                                            </ul>
                                                                        </div>
                                                                        <div
                                                                            class="col-12 col-xl-4 single-mega-item rbt-scroll-trigger fade_in animation-order-1 mt--16">
                                                                            <p class="rbt-short-title h5">Boost Sales
                                                                            </p>
                                                                            <ul class="mega-menu-item">
                                                                                <li><a href="notifications.html">Back
                                                                                        To Stock Notification</a></li>
                                                                                <li><a href="sales-popup.html">Sales
                                                                                        Popup</a></li>
                                                                                <li><a href="pre-order.html">Pre
                                                                                        Order</a></li>
                                                                                <li><a
                                                                                        href="backorder.html">Backorder</a>
                                                                                </li>
                                                                                ...
                                                                                <li><a href="shareable-cart.html">Shareable
                                                                                        Cart</a></li>
                                                                                <li><a
                                                                                        href="bulk-amount-purchase.html">Bulk
                                                                                        Amount Purchase</a></li>
                                                                                <li><a href="stock-progressbar.html">Stock
                                                                                        Progress Bar</a></li>
                                                                                <li><a
                                                                                        href="sale-push-notification.html">Sales
                                        ...
                                        <li class="has-dropdown position-relative">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li><a href="https://rainbowthemes.net/services/">Customization</a>
                                                </li>
                                            </ul>
                                        </li>
                        ...
                        <div class="header-right rbt-gap--32">
                            ...
                            <ul class="rbt-quick-access">
                                <li class="rbt-access-box rbt-scroll-trigger fade_in animation-order-3 tooltips tooltip-distance-lg"
                                    ...
                                    <a class="search-trigger-active rbt-round-btn has-rbt-md-fsize rbt-modern-close-btn"
                                        href="#">
                                ...
                                <li class="rbt-access-box rbt-scroll-trigger fade_in animation-order-3 d-none d-lg-flex tooltips tooltip-distance-lg"
                                    ...
                                    <a class="rbt-round-btn has-rbt-md-fsize" href="#!"
                                ...
                                <li class="rbt-access-box rbt-scroll-trigger fade_in animation-order-5 rbt-mini-cart tooltips tooltip-distance-lg"
                                    data-tooltip="Cart" data-tooltip-position="bottom">
                                    <a class="rbt-cart-sidenav-activation rbt-round-btn has-rbt-md-fsize"
                                        href="#">
                                        <i class="fa-regular fa-bag-shopping"></i>
        ...
        <div
            class="rbt-header-common-sticky-activation rbt-header-wrapper-common justify-content-between nbc-shop-header">
            <div
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="rbt-fancy-item fancy-menu-text fancy-menu-center">
                                                    <p class="rbt-fancy-text rbt-text-color-white">Top products.
                                                        Better prices
                                                        -under Rs. 100.
                                                        <a class="rbt-text-color-white"
                                        ...
                                        <div class="rbt-megamenu rbt-megamenu-4">
                                            <div class="rbt-megamenu-wrapper p--0">
                                                <div class="row row--0">
                                                    <div class="col-3 ">
                                                        <div class="rbt-menu-tab-wrapper">
                                                            <nav id="rbt-megamenuTab-cs"
                                                                class="nav nav-pills flex-column rbt-megamenu-tab rbt-megamenu-tab-cs-activation">
                                                                <a href="#rbt-megamenu_tab1-cs"
                                                                    data-bs-toggle="pill" class="active nav-link">
                                                                    <span><i class="fa-regular fa-store"></i></span>
                                                                    Shop Pages
                                                                    <span class="rbt-chevron-right"><i
                                                                            class="fa-regular fa-chevron-right"></i></span>
                                                                </a>
                                                                <a href="#rbt-megamenu_tab3-cs"
                                                                    data-bs-toggle="pill" class="nav-link">
                                                                    <span><i class="fa-regular fa-shirt"></i></span>
                                                                    Single Product
                                                                    <span class="rbt-chevron-right"><i
                                                                            class="fa-regular fa-chevron-right"></i></span>
                                                                </a>
                                                                <a href="#rbt-megamenu_tab2-cs"
                                                                    data-bs-toggle="pill" class="nav-link">
                                                                    <span><i
                                                                            class="fa-regular fa-swatchbook"></i></span>
                                                                    Products Variation
                                                    ...
                                                    <div class="col-9">
                                                        <div class="rbt-menu-tab-content-wrapper">
                                                            <div class="tab-content rbt-megamenu-tab-content"
                                                                id="megamenu-tab1-content">
                                                                <div class="tab-pane show active"
                                                                    id="rbt-megamenu_tab1-cs">
                                                                    <div class="row row--24">
                                                                        <div class="col-xl-8">
                                                                            <div class="row row--8">
                                                                                <div
                                                                                    class="col-xl-4 single-mega-item rbt-scroll-trigger fade_in animation-order-1">
                                                                                    <p class="rbt-short-title h5">Shop
                                                                                        Pages</p>
                                                                                    <ul class="mega-menu-item">
                                                                                        <li>
                                                                                            <a
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <ul class="mega-menu-item">
                                                                                        ...
                                                                                        <li><a href="shop-wider.html">Three
                                                                                                Columns Wide</a></li>
                                                                                        <li><a
                                                                                                href="shop-wider-four.html">
                                                                                                Four Columns
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <p
                                                                                                class="b4 subtitle mb--0">
                                                                                                Embrace comfy wear</p>
                                                                                            <p class="h5 mb--4">Ready
                                                                                                to fall in love
                                                                                                with Autumn collection!
                                                                                            </p>
                                                                                        </div>
                                                                                        <a class="rbt-btn rbt-bg-color-secondary rbt-btn-sm"
                                                                                            href="{{ route('shop') }}">Shop
                                                                ...
                                                                <div class="tab-pane fade"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="row row--24">
                                                                            ...
                                                                            <div class="col-xl-3 single-mega-item">
                                                                                <p class="rbt-short-title h5">Custom
                                                                                    Design</p>
                                                                                <ul class="mega-menu-item">
                                                                                    <li><a
                                                                                            href="product-single-sticky-info.html">Product
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="row">
                                                                    <div
                                                                        ...
                                                                        <ul class="mega-menu-item">
                                                                            <li><a href="contact.html">Contact Page
                                                                                    One</a></li>
                                                                    ...
                                                                    <div
                                                                        class="col-12 col-lg-1-5 single-mega-item rbt-scroll-trigger fade_in animation-order-1 mt--16">
                                                                        <p class="rbt-short-title h5">Shop User Pages
                                                                        </p>
                                                                        <ul class="mega-menu-item">
                                                                            <li><a href="my-order-history.html">Order
                                                                                    History</a></li>
                                                    ...
                                                    <div class="col-xl-9">
                                                        <div class="h-100 d-flex flex-column justify-content-between">
                                                            <div class="row row--12">
                                                                ...
                                                                <div
                                                                    class="col-xl-3 single-mega-item rbt-scroll-trigger fade_in animation-order-1">
                                                                    <p class="rbt-short-title h5">Template Elements
                                                                    </p>
                                                                    <ul class="mega-menu-item">
                                                                        <li><a href="element-hotspot-styles.html">Hotspot
                                                                                Styles</a></li>
                                                            ...
                                                            <div class="mega-top-banner">
                                                                <div
                                                                    ...
                                                                    <div class="rbt-banner-content">
                                                                        <h2 class="title rbt-text-color-white">New
                                                                            Aurora Watch</h2>
                                                                        <p class="b3 desc rbt-text-color-gray-200">
                                                                            Send your idea, appear Unimart.</p>
                                                                    </div>
                                                                    <a class="rbt-btn rbt-btn-sm"
                                                                        href="#">View Details</a>
            ...
            <div class="rbt-search-dropdown rbt-common-search-dropdown-activation">
                <div class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="rbt-component-section-title border-0 p-0 text-center">
                                <h2 class="rbt-title text-start text-md-center"><span class="rbt-bold--text">Search
                                        For
                                        Products</span></h2>
                            </div>
                        </div>
    ...
    <footer
        class="rbt-footer rbt-footer-style-seven rbt-bg-color-white position-relative overflow-hidden pb--112 pb_sm--44">
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="rbt-app-store-area mt--24">
                                <ul class="rbt-app-store-list has-larger-img">
                                    <li><a href="#"><img
                                                src="{{ asset('assets/images/footer/play-store-logo.webp') }}"
                                                alt="App Store"></a></li>
                                    <li><a href="#"><img
                                                src="{{ asset('assets/images/footer/apple-store-logo.webp') }}"
                                                alt="App Store"></a></li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row row--12 mt_dec--24 align-items-center justify-content-between">
                    <div class="col-xxl-3 col-lg-4 col-md-6 col-12 mt--24">
                        <div
                            class="footer-widget d-flex flex-column align-items-start rbt-gap--8 justify-content-lg-end">
                            <h3 class="ft-title mb--0">Our Social Links:</h3>
                            <ul
                                class="social-icon social-icon-sm rbt-social-default with-bg-primary justify-content-start justify-content-lg-end">
                    ...
                    <div class="col-xxl-4 col-lg-4 col-md-6 col-12 mt--24">
                        <div
                            ...
                            <ul class="payment-img-link justify-content-start">
                                <li>
                                    <a href="#!"><img
                                            src="{{ asset('assets/images/payment-brand/image-01.webp') }}"
            ...
            <div class="container">
                <div class="row row--12 align-items-center justify-content-between mt_dec--24">
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-12 col-12 mt--24">
                        <p class="rbt-link-hover text-center text-lg-start">Copyright <span
                                class="copyright-year">2025</span> &copy; <a class="rbt-text-semi-bold"
                                href="https://rainbowthemes.net/">Unimart</a> HTML Template.</p>
                    </div>
                    <div class="col-xxl-4 col-xl-4 col-lg-5 col-md-12 col-12 mt--24">
                        <ul
                            class="copyright-link rbt-link-hover justify-content-center justify-content-xl-end mt_sm--12 mt_md--12">
                        ...
                        <div class="rbt-login-form-inner">
                            ...
                            <div class="rbt-login-form-bottom rbt-swiper-container-pagination position-relative">
                                <div class="swiper rbt-log-slide-activation pb--40">
                                    ...
                                    <div
                                        class="swiper-pagination rbt-swiper-progress rbt-swiper-pagination-dot-extend">
                                    </div>
                                </div>
                            </div>
                            <!-- End slider -->
    ...
    <div class="rbt-default-modal modal fade has-rbt-top-folder-shape" id="demos-modal" tabindex="-1"
        aria-hidden="true">
                        ...
                        <div class="container">
                            <div class="row overflow-hidden">
                                <div class="col-12 col-lg-10 col-xl-9 mx-auto">
                                    <div
                                        class="rbt-exclusive-section-title text-center position-relative pt--48 mb--20">
                                        ...
                                        <h2 class="rbt-title mb--48 sm_mb--32 md_mb--40">
                                            ...
                                            <span class="rbt-title-sm-text">To Discover Awesome Creative
                                                Designs</span>
                                        </h2>
                                        <div class="section-indicator d-xl-none d-xxl-block">
                                            <span class="icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="54"
                                                    height="26" viewbox="0 0 54 26" fill="none">
                                                    <path
                                    ...
                                    <div class="rbt-isotop-scroll rbt-scroll-trigger fade_in animation-order-3">
                                        <div class="rbt-isotop-tabs rbt-nav-effect-activation">
                                            <div class="rbt-product-nav-grp rbt-tab-btn-list">
                                                <button data-filter="*" class="active"><span
                                                        class="filter-text">All
                                                        Together</span></button>
                                                <button data-filter=".fashion"><span
                                                        class="filter-text">Fashion</span></button>
                                                <button data-filter=".accessories"><span
                                                        class="filter-text">Accessories</span></button>
                                                <button data-filter=".furniture"><span
                                                        class="filter-text">Furniture</span></button>
                                                <button data-filter=".electronics"><span
                                                        class="filter-text">Electronics</span></button>
                                                <button data-filter=".cosmetics"><span
                                                        class="filter-text">Cosmetics</span></button>
                                                <button data-filter=".interior"><span
                                                        class="filter-text">Decor/Interior</span></button>
                                                <button data-filter=".printing"><span
                                                        class="filter-text">Printing</span></button>
                                                <button data-filter=".sports"><span
                                                        class="filter-text">Sports</span></button>
                                            </div>
                                            <div class="rbt-product-nav-grp rbt-tab-btn-list">
                                                <button data-filter=".coming-soon"><span class="filter-text">️‍🔥
                                                        Coming
                                                        Soon</span></button>
                                            </div>
                                            ...
                                            <div class="grid-5-meso">
                                                ...
                                                <div class="rbt-meso-item transition furniture">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            ...
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-furniture.html">Furniture - 1</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            ...
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-jewellery.html">Jewellery - 1</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-furniture-two.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-furniture-02.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-furniture-two.html">Furniture -
                                                                        2</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-fashion-two.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-fashion-02.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-fashion-two.html">Fashion - 2</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-ladies-bag.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-leather-goods-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-ladies-bag.html">Luxury
                                                                        leather goods</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-perfume.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-fragrance-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-perfume.html">Fragrance</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-jewellery-two.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-jewellery-02.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-jewellery-two.html">Jewellery -
                                                                        2</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-cosmetic-beauty-two.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-cosmetics-02.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-cosmetic-beauty-two.html">Cosmetics
                                                                        Beauty 2</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-cosmetic-beauty-three.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-cosmetics-03.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-cosmetic-beauty-three.html">Cosmetics
                                                                        Beauty 3</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="{{ route('home') }}"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-cosmetics-04.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="{{ route('home') }}">Cosmetics
                                                                        Beauty 4</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-laggage-bag.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-11.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-laggage-bag.html">Luggage Shop</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion electronics">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-watch.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-watch-02.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-watch.html">Watch
                                                                        Shop</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-straller.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-11.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-straller.html">Stroller
                                                                        (Baby Walker)</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-paddle-boards.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-paddle-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-paddle-boards.html">Paddle
                                                                        Boards</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-shocks-store.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-socks-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-shocks-store.html">Socks
                                                                        Store</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion electronics">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-headphones-store.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-headphone-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-headphones-store.html">Headphones
                                                                        Store</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-dog-accessories.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-dog-accessories-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-dog-accessories.html">Dog
                                                                        Accessories</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-cat-accessories-01.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-cat-accessories-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-cat-accessories-01.html">Cat
                                                                        Accessories</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-kids-cloth.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-kids-cloth-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-kids-cloth.html">Kids
                                                                        Cloth</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-gym-supliments-one.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-gym-suppliment-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-gym-supliments-one.html">Gym
                                                                        Supplement</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-plant-one.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-plant-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-plant-one.html">Plants
                                                                        Store </a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-kitchen-accessories.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-kitchenware-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-kitchen-accessories.html">Kitchen
                                                                        Accessories</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone electronics">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-electric-cycle.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-cycle-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-electric-cycle.html">Electric
                                                                        Cycle</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-fashion-three.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-fashion-03.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-fashion-three.html">Fashion - 3</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-ceramics.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-ceramic-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-ceramics.html">Ceramics
                                                                        Store</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-drinkware.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-drinkware-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-drinkware.html">Drinkware Shop</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-camping-gear.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-camping-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-camping-gear.html">Camping Gear</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-flower-plants.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-flowers-shop-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-flower-plants.html">Flowers
                                                                        Plants</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-tennis-accessories.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-tennis-accessories-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-tennis-accessories.html">Tennis
                                                                        Accessories</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-coffee-store.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-coffee-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-coffee-store.html">Coffee Store</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-bakery-shop.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-bakery-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-bakery-shop.html">Bakery
                                                                        Shop</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-packaging-shop.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-packaging-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-packaging-shop.html">Packaging
                                                                        Shop</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-hoodie-stores-one.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-hoodie-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-hoodie-stores-one.html">Hoodie
                                                                        Store -
                                                                        1</a></h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-hoodie-stores-two.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-hoodie-02.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-hoodie-stores-two.html">Hoodie
                                                                        Store -
                                                                        2</a></h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-borkha-shop.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-11.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-borkha-shop.html">Borka
                                                                        Shop</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-hijab-shop.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-hijab-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-hijab-shop.html">Hijab
                                                                        Shop</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-hats-store.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-hat-store-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-hats-store.html">Hats
                                                                        Store</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-sneakers.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-sneakers-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-sneakers.html">Sneakers</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-yoga-store.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-11.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-yoga-store.html">Yoga
                                                                        Store</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-furniture-three.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-11.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-furniture-three.html">Furniture -
                                                                        3</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-shoes.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-shoes-women-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-shoes.html">Shoes</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-organic-food.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-organic-food-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-organic-food.html">Organic Food
                                                                        Shop</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-black-friday-sale.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-black-friday-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-black-friday-sale.html">Black
                                                                        Friday
                                                                        Sale</a></h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-tea-stores.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-tea-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-tea-stores.html">Tea
                                                                        Store</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-book-store.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-book-shop-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-book-store.html">Book
                                                                        Shop</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-furniture-four.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-11.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-furniture-four.html">Furniture -
                                                                        4</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion electronics">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-watch-two.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-watch-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-watch-two.html">Smart
                                                                        watch</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-games-store.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-game-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-games-store.html">Games
                                                                        Store</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition electronics">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-car-automobile-accessories.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-car-%26-automobile-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-car-automobile-accessories.html">Car
                                                                        &
                                                ...
                                                <div class="rbt-meso-item transition electronics">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-electronics-two.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-electronics-02.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-electronics-two.html">Electronics -
                                                                        2</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition electronics">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-electronics-three.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-electronics-03.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-electronics-three.html">Electronics
                                                                        -
                                                                        3</a></h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition electronics">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-electronics-four.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-electronics-04.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-electronics-four.html">Electronics
                                                                        -
                                                                        4</a></h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-beard-oil.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-beard-oil-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-beard-oil.html">Beard
                                                                        Oil Shop</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-cyber-monday.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-11.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-cyber-monday.html">Cyber
                                                                        Monday Sale</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition electronics">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-laptop.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-laptop-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-laptop.html">Laptop
                                                                        Store</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone electronics">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-mobile-phone.html"><img
                                                                        src="{{ asset('assets/images/splash/demo-pages/demo-mobile-01.webp') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-mobile-phone.html">Mobile Phone
                                                                        Store</a>
                                                                </h3>
                                                            </div>
                                                        </div>
            ...
            <div class="row row row--0">
                <div class="col-md-12">
                    <ul class="rbt-quick-access onepagenav">
                        ...
                        <li class="rbt-access-box">
                            <a href="#!" class="rbt-round-btn has-rbt-md-fsize" data-bs-toggle="modal"
                                data-bs-target="#signinModal">
                                <i class="fa-regular fa-user"></i>
    ...
    <script type="module" src="beacon.min.js/v4513226cdae34746b4dedf0b4dfa099e1781791509496"
        ...
        data-cf-beacon='{"version":"2024.11.0","token":"4a64ee10db7a4427ba649e901229556e","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}'
