                        ...
                        <tr class="hover:bg-surface-body/70 transition-colors">
                            ...
                            <td class="py-4 pr-4">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    @endif
                                    <a href="{{ route('admin.products.variants.manage', $product->id) }}" class="inline-flex items-center gap-1 rounded border border-brand-200 bg-brand-50 px-2 py-1 text-[11px] font-semibold text-brand-600 hover:bg-brand-100 transition-colors" title="Manage Stock, Variant Prices, Weight & Images">
                            ...
                            <td class="py-4 pr-4 text-right">
                                <div class="inline-flex items-center gap-2">
                                    <a href="{{ route('admin.products.variants.manage', $product->id) }}" class="inline-flex h-8 w-8 items-center justify-center rounded-base border border-surface-line text-ink-500 hover:bg-brand-50 hover:text-brand-600 hover:border-brand-200 transition-colors" title="Manage Stock & Variants">
