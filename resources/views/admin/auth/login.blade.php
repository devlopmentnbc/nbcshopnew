...
<head>
    ...
    <style>
        ...
        @font-face {
            ...
            font-display: swap;
            font-weight: 400;
            src: url(./cabin-latin-ext-400-normal-BSmiwBS3.woff2)format("woff2"), url(./cabin-latin-ext-400-normal-Bt6cbo2a.woff)format("woff");
        ...
        @font-face {
            ...
            font-display: swap;
            font-weight: 400;
            src: url(./cabin-latin-400-normal-CexE3FJz.woff2)format("woff2"), url(./cabin-latin-400-normal-BKl0A_G7.woff)format("woff");
        ...
        @font-face {
            ...
            font-display: swap;
            font-weight: 500;
            src: url(./cabin-latin-ext-500-normal-Dd8oGPtE.woff2)format("woff2"), url(./cabin-latin-ext-500-normal-CwzuROK2.woff)format("woff");
            unicode-range: U+100-2BA, U+2BD-2C5, U+2C7-2CC, U+2CE-2D7, U+2DD-2FF, U+304, U+308, U+329, U+1D00-1DBF, U+1E00-1E9F, U+1EF2-1EFF, U+2020, U+20A0-20AB, U+20AD-20C0, U+2113, U+2C60-2C7F, U+A720-A7FF
        }
        ...
        @font-face {
            ...
            font-display: swap;
            font-weight: 500;
            src: url(./cabin-latin-500-normal-IdFnxyia.woff2)format("woff2"), url(./cabin-latin-500-normal-C-SyL_Me.woff)format("woff");
            unicode-range: U+??, U+131, U+152-153, U+2BB-2BC, U+2C6, U+2DA, U+2DC, U+304, U+308, U+329, U+2000-206F, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD
        }
        ...
        @font-face {
            ...
            font-display: swap;
            font-weight: 600;
            src: url(./cabin-latin-ext-600-normal-iRd6qmG6.woff2)format("woff2"), url(./cabin-latin-ext-600-normal-01HZJGla.woff)format("woff");
            unicode-range: U+100-2BA, U+2BD-2C5, U+2C7-2CC, U+2CE-2D7, U+2DD-2FF, U+304, U+308, U+329, U+1D00-1DBF, U+1E00-1E9F, U+1EF2-1EFF, U+2020, U+20A0-20AB, U+20AD-20C0, U+2113, U+2C60-2C7F, U+A720-A7FF
        }
        ...
        @font-face {
            ...
            font-display: swap;
            font-weight: 600;
            src: url(./cabin-latin-600-normal-DtpeLQXC.woff2)format("woff2"), url(./cabin-latin-600-normal-BusbDEVs.woff)format("woff");
            unicode-range: U+??, U+131, U+152-153, U+2BB-2BC, U+2C6, U+2DA, U+2DC, U+304, U+308, U+329, U+2000-206F, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD
        }
        ...
        @font-face {
            ...
            font-display: swap;
            font-weight: 700;
            src: url(./cabin-latin-ext-700-normal-DYYWRumJ.woff2)format("woff2"), url(./cabin-latin-ext-700-normal-_eT1Tcz0.woff)format("woff");
            unicode-range: U+100-2BA, U+2BD-2C5, U+2C7-2CC, U+2CE-2D7, U+2DD-2FF, U+304, U+308, U+329, U+1D00-1DBF, U+1E00-1E9F, U+1EF2-1EFF, U+2020, U+20A0-20AB, U+20AD-20C0, U+2113, U+2C60-2C7F, U+A720-A7FF
        }
        ...
        @font-face {
            ...
            font-display: swap;
            font-weight: 700;
            src: url(./cabin-latin-700-normal-BSVyX4_V.woff2)format("woff2"), url(./cabin-latin-700-normal-BOC0lh-o.woff)format("woff");
            unicode-range: U+??, U+131, U+152-153, U+2BB-2BC, U+2C6, U+2DA, U+2DC, U+304, U+308, U+329, U+2000-206F, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD
        }
        ...
        @layer theme {
            ...
            :host {
                ...
                --color-brand-200: #bcd2f4;
                --color-brand-300: #a4c2f1;
                --color-brand-400: #7a9ce9;
                --color-brand-500: #426de0;
                --color-brand-600: #215ada;
                --color-brand-700: #1d49b8;
                --color-accent-50: #fff0ec;
                --color-accent-100: #ffe1d6;
                --color-accent-500: #ff4c1a;
                --color-accent-700: #b8320d;
                --color-success-50: #e5fae5;
                --color-success-100: #cff5d0;
                --color-success-500: #24bd25;
                --color-success-600: #157f16;
                --color-success-700: #0e5f0f;
                --color-warning-50: #fff5e1;
                --color-warning-100: #fceac2;
                --color-warning-500: #f5b24f;
                --color-warning-600: #9a5b00;
                --color-danger-50: #fdecec;
                --color-danger-100: #fbd7d7;
                --color-danger-500: #d12626;
                --color-danger-600: #c02626;
                --color-admin-sidebar: #0f9b86;
                --color-admin-sidebar-dark: #087b70;
                --color-admin-teal: #0da487;
                --radius-base: 6px;
                --radius-card: 10px;
                --spacing-sidebar: 278px;
                --spacing-topbar: 72px;
                --color-surface-line: rgb(var(--surface-line))
            }
        }
        ...
        @layer base {
            ...
            *,
            ...
            body {
                background-color: rgb(var(--surface-body));
            ...
            input[type=radio] {
                appearance: none;
                border: 1.5px solid var(--color-surface-line);
                cursor: pointer;
                background-color: #0000;
                flex-shrink: 0;
                position: relative
            ...
            input[type=checkbox].text-accent-500:checked,
            input[type=checkbox].text-accent-600:checked,
            input[type=radio].text-accent-500:checked,
            input[type=radio].text-accent-600:checked {
                background-color: var(--color-accent-500);
                border-color: var(--color-accent-500)
            }

            input[type=checkbox].text-success-600:checked,
            ...
            [tabindex]:focus-visible {
                box-shadow: 0 0 0 2px rgb(var(--surface-card)), 0 0 0 4px #215ada;
                outline: none
            }
        ...
        @layer utilities {
            ...
            :where(.divide-surface-line>:not(:last-child)) {
                border-color: rgb(var(--surface-line))
            }
            ...
            .bg-ink-300 {
                background-color: rgb(var(--ink-300))
            }
            ...
            @supports (color:color-mix(in lab, red, red)) {
                .bg-ink-900\/40 {
                    background-color: color-mix(in oklab, rgb(var(--ink-900)) 40%, transparent)
                }
            }
            ...
            @supports (color:color-mix(in lab, red, red)) {
                .bg-ink-900\/45 {
                    background-color: color-mix(in oklab, rgb(var(--ink-900)) 45%, transparent)
                }
            }
            ...
            @supports (color:color-mix(in lab, red, red)) {
                .bg-ink-900\/50 {
                    background-color: color-mix(in oklab, rgb(var(--ink-900)) 50%, transparent)
                }
            }
            ...
            @supports (color:color-mix(in lab, red, red)) {
                .bg-ink-900\/60 {
                    background-color: color-mix(in oklab, rgb(var(--ink-900)) 60%, transparent)
                }
            }
            ...
            .bg-surface-line {
                background-color: rgb(var(--surface-line))
            }
            ...
            @supports (color:color-mix(in lab, red, red)) {
                .bg-surface-muted\/50 {
                    background-color: color-mix(in oklab, rgb(var(--surface-muted)) 50%, transparent)
                }
            }
            ...
            .from-admin-sidebar {
                --tw-gradient-from: var(--color-admin-sidebar);
                --tw-gradient-stops: var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))
            }

            .to-admin-sidebar-dark {
                --tw-gradient-to: var(--color-admin-sidebar-dark);
                --tw-gradient-stops: var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))
            }
            ...
            .text-surface-line\/70 {
                color: rgb(var(--surface-line))
            }

            @supports (color:color-mix(in lab, red, red)) {
                .text-surface-line\/70 {
                    color: color-mix(in oklab, rgb(var(--surface-line)) 70%, transparent)
                }
            }
            ...
            .shadow-lift {
                --tw-shadow: 0 10px 35px 0 var(--tw-shadow-color, #00000014);
                box-shadow: var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow)
            }

            .shadow-soft {
                --tw-shadow: 0 4px 30px 10px var(--tw-shadow-color, #0000000d);
                box-shadow: var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow)
            }
            ...
            @media (hover:hover) {
                ...
                .group-hover\:text-brand-400:is(:where(.group):hover *) {
            ...
            @media (hover:hover) {
                ...
                .hover\:bg-surface-body:hover,
                .hover\:bg-surface-body\/60:hover {
                    background-color: rgb(var(--surface-body))
                }

                @supports (color:color-mix(in lab, red, red)) {
                    .hover\:bg-surface-body\/60:hover {
                        background-color: color-mix(in oklab, rgb(var(--surface-body)) 60%, transparent)
                    }
                }

                .hover\:bg-surface-body\/70:hover {
                    background-color: rgb(var(--surface-body))
                }

                @supports (color:color-mix(in lab, red, red)) {
                    .hover\:bg-surface-body\/70:hover {
                        background-color: color-mix(in oklab, rgb(var(--surface-body)) 70%, transparent)
                    }
                }
            ...
            .focus-visible\:ring-offset-surface-card:focus-visible {
                --tw-ring-offset-color: rgb(var(--surface-card))
            }
            ...
            @media (hover:hover) {
                ...
                .disabled\:hover\:text-ink-500:disabled:hover {
                    color: rgb(var(--ink-500))
                }
            }
            ...
            @media (width>=40rem) {
                ...
                .sm\:grid-cols-\[160px_140px_minmax\(0\,1fr\)_auto\] {
            ...
            @media (width>=64rem) {
                ...
                .lg\:grid-cols-\[minmax\(0\,0\.9fr\)_minmax\(460px\,1fr\)\] {
            ...
            @media (width>=80rem) {
                ...
                .xl\:grid-cols-\[minmax\(0\,1fr\)_minmax\(480px\,0\.9fr\)\] {
        ...
        :root {
            --surface-body: 249 249 249;
            --surface-card: 255 255 255;
            --surface-muted: 243 243 243;
            --surface-line: 230 230 230;
            --ink-300: 193 193 193;
            --ink-400: 110 110 110;
            --ink-500: 85 85 85;
            --ink-600: 68 68 68;
        ...
        .dark {
            --surface-body: 15 19 28;
            --surface-card: 24 29 41;
            --surface-muted: 35 42 58;
            --surface-line: 47 55 74;
            --ink-300: 90 102 122;
            --ink-400: 124 136 156;
            --ink-500: 148 163 184;
            --ink-600: 174 185 204;
        ...
        :is(article:has(#revenueChart), article:has(#earningChart), article:has(#visitorsChart)) {
            min-width: 0;
            overflow: hidden
        }

        body[data-page=add-product] main,
        body[data-page=edit-product] main {
            overflow-x: hidden
        }
        ...
        #add-product-form article,
        #edit-product-form article,
        ...
        #add-product-form .modern-select,
        #edit-product-form .modern-select {
            min-width: 0;
            max-width: 100%
        }
        ...
        @media (width<=639px) {
            ...
            body[data-page=add-product] .add-product-page-header,
            body[data-page=edit-product] .edit-product-page-header,
            body[data-page=add-product] #add-product-form,
            body[data-page=edit-product] #edit-product-form {
                width: calc(100vw - 2rem);
                max-width: calc(100vw - 2rem)
            }

            body[data-page=add-product] #add-product-form article,
            body[data-page=edit-product] #edit-product-form article {
                overflow: hidden
            }
        }

        .sidebar-ready #admin-sidebar {
            transition: width .3s, transform .3s
        }

        @media (width>=1024px) {
            .sidebar-ready .lg\:pl-sidebar {
            ...
            .sidebar-collapsed .lg\:pl-sidebar {
                padding-left: 80px
            }

            .sidebar-collapsed #admin-sidebar .nav-text,
            .sidebar-collapsed #admin-sidebar .ws-text,
            .sidebar-collapsed #admin-sidebar .user-text,
            .sidebar-collapsed #admin-sidebar .logo-full,
            .sidebar-collapsed #admin-sidebar .nav-search,
            .sidebar-collapsed #admin-sidebar [data-nav-submenu] {
                display: none
            }

            .sidebar-collapsed #admin-sidebar .logo-mark {
                display: grid
            }

            .sidebar-collapsed #admin-sidebar .sidebar-link,
            .sidebar-collapsed #admin-sidebar .ws-switch,
            .sidebar-collapsed #admin-sidebar .user-switch {
                cursor: pointer;
                justify-content: center
            }
        ...
        .preloader-msg {
            ...
            margin: 0;
            font-size: 14px;
            animation: .3s linear 13.7s forwards ldr-msg;
            position: absolute;
            left: 0
        }
        ...
        .rbt-preloader-cart-wheel2,
        .rbt-preloader-cart-wheel-stroke {
            animation: 2s ease-in-out infinite ldr-cartLines
        }
...
<body class="min-h-screen bg-surface-body">
    <!-- Preloader -->
    <div class="rbt-preloader" data-preloader="">
        <div class="rbt-preloader-inner">
            <svg class="rbt-preloader-cart" role="img" aria-label="Shopping cart line animation"
                ...
                <g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="8">
                    ...
                    <g class="rbt-preloader-cart-lines" stroke="currentColor">
                        <polyline class="rbt-preloader-cart-top"
                            ...
                            stroke-dashoffset="-338"></polyline>
    ...
    <main class="grid min-h-screen lg:grid-cols-[minmax(0,0.9fr)_minmax(460px,1fr)]">
        <section
            class="hidden bg-gradient-to-b from-admin-sidebar to-admin-sidebar-dark p-10 text-white lg:flex lg:flex-col">
            <a href="{{ route('admin.dashboard') }}" class="inline-flex items-center" aria-label="NBC dashboard">
                <img src="{{ asset('assets/images/nbc/logo-nbc2.png') }}" alt="NBC" class="h-10 w-auto">
            </a>
            <div class="mt-auto max-w-lg">
                <p class="text-[14px] font-semibold uppercase text-white/70">Admin workspace</p>
                <h1 class="mt-3 text-[38px] font-semibold leading-tight text-white">
                    A calm command center for NBC.
                </h1>
                <p class="mt-4 text-[16px] leading-7 text-white/75">
                    Manage catalog, orders, customers, and fulfillment with the same restrained NBC visual language.
                </p>
            </div>
        </section>
        ...
        <section class="flex items-center justify-center px-4 py-10">
            <form method="POST" action="{{ route('admin.login.submit') }}"
                ...
                <div class="mt-5 flex items-center justify-between gap-3 text-[14px]">
                ...
                <button type="submit"
                    class="mt-6 inline-flex h-11 w-full items-center justify-center rounded-base bg-brand-600 text-[14px] font-semibold text-white hover:bg-brand-700 transition-colors">Sign
                    In</button>
            </form>
        </section>
    </main>
