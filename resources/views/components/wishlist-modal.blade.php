            ...
            <div class="rbt-top-folder-shape-wrapper">
                <div class="rbt-bg-color-white rbt-content-trs-portion">
                    <div class="rbt-wishlist-modal-content">
                        <div class="rbt-title rbt-text-bold h5 mb--20" id="wishlistModalLabel">
                            <i class="fa-solid fa-heart text-danger me-2"></i>My Wishlist <span class="nbc-wishlist-modal-count badge bg-light text-dark rounded-pill ms-2" style="font-size: 13px;">0</span>
                        </div>
                        <div class="rbt-transparent-table-one-wrapper rbt-has-bg-gray pt--0 pb--0 mb--16">
                            <table class="rbt-transparent-table-one mb--0 rbt-wishlist-table">
                                <tbody class="nbc-wishlist-modal-items">
                                    <!-- Dynamic items loaded via JavaScript -->
                                    <tr>
                        ...
                        <div class="rbt-wishlist-modal-footer d-flex flex-wrap rbt-gap--16 justify-content-between align-items-center">
                            <a href="{{ route('shop') }}" class="rbt-btn rbt-btn-sm rbt-btn-border">Continue Shopping</a>
                        </div>
                    </div>
                </div>
            </div>
