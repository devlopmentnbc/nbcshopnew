...
@section('title', 'Home Cosmetic Beauty Shop - eCommerce Bootstrap5 Template')
    ...
    <ul class="mainmenu">
        ...
        <div class="mobile-menu-bottom">
            ...
            <ul class="navbar-top-left rbt-information-list justify-content-center">
                <li>
                    <a href="/cdn-cgi/l/email-protection#6008050c0c0f200518010d100c054e030f0d"><i class="fa-light fa-envelope"></i><span class="__cf_email__" data-cfemail="c6a3bea7abb6aaa386a1aba7afaae8a5a9ab">[email&#160;protected]</span></a>
                </li>
                <li>
                    ...
                    <div class="rbt-sidebar-left-content-footer">
                        <div class="rbt-sidebar-contact-area">
                            <div class="rbt-sidebar-contact-inner rbt-link-hover">
                                ...
                                <a class="rbt-contact-links" href="/cdn-cgi/l/email-protection#84e0e1e9ebc4e1fce5e9f4e8e1aae7ebe9"><span class="__cf_email__" data-cfemail="8befeee6e4cbeef3eae6fbe7eea5e8e4e6">[email&#160;protected]</span></a>
...
<!-- End Side Nav -->
    ...
    <div class="rbt-component-area rbt-products-banner-area rbt-bg-color-white">
        <div class="wrapper plr--80 plr_lg--20 plr_md--20 plr_sm--20">

            <div class="rbt-product-banner rbt-product-banner-style-four rbt-product-banner-style-four-hv-one rbt-hero-banner rbt-banner-four-var-two rbt-banner-four-var-two-medium rbt-bg-color-brand-100 rbt-scroll-trigger fade_in animation-order-3">
                <div class="rbt-banner-inner">
                    <div class="rbt-product-banner-content text-center p--72 p_sm--32 d-flex justify-content-center align-items-center">
                        <div class="rbt-content-section rbt-slideshow-content-inner effect_fadeindown">
                            <span class="rbt-banner-subtitle-two h4 mb-0">Exclusive
                                Offer Going</span>
                            <h1 class="rbt-title mb-0 h1"><span class="rbt-bold--text d-block">Discover the
                                    unimart Fragrance</span>
                                floral & joyful accord of rose & cherry.</h1>
                            <div class="rbt-banner-btn-grp d-flex rbt-gap--1 6 mt--32 mt_sm--16 justify-content-center">
                                <a class="rbt-btn" href="shop-by-categories.html">Shop Collection</a>
                            </div>
                        </div>
                    </div>
                    <div class="rbt-product-img rbt-scroll-trigger zoom_in animation-order-3">
                        <img src="{{ asset('assets/images/product-banner/product-banner-beauty-lg-a1.webp') }}" alt="eCommerce Product Banner Background">
                    </div>
                </div>
            </div>
    ...
    <!-- Start Component Area -->
    <div class="rbt-component-area rbt-catagories-area rbt-bg-color-white rbt-section-gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-between flex-row align-items-end mb--40 flex-wrap rbt-gap--16">
                    <div class="rbt-component-section-title rbt-gap--4 mb--0 p-0 border-0">
                        <h2 class="rbt-title rbt-scroll-trigger fade_in animation-order-1">Discover the <span class="rbt-bold--text">World Of Fragrance</span></h2>
                    </div>
                    <a class="rbt-btn rbt-btn-secondary rbt-btn-sm-2 rbt-scroll-trigger fade_in animation-order-2" href="categories-list.html">
                    ...
                    <div class="rbt-cat-box rbt-cat-box-5 variation-one rbt-scroll-trigger fade_in animation-order-1">
                        <div class="inner">
                            <div class="rbt-image-portion position-relative overflow-hidden">
                                <a href="#">
                                    <img class=" rbt-scroll-trigger zoom_in animation-order-1" src="{{ asset('assets/images/catagory-img/cat-bp-bg-a-01.webp') }}" alt="Catagory Product Images">
                                </a>
                                <div class="rbt-right-corner-portion bottom--position">
                                    <div class="rbt-corner-portion-wrapper">
                                        <a href="#" class="rbt-card-link-btn"><i class="fa-solid fa-arrow-up-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="content text-center">
                                <p class="title">
                                    <a href="#">Unisex Fragrance</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-1-5 col-md-4 col-6 mt--24">
                    <div class="rbt-cat-box rbt-cat-box-5 variation-one rbt-scroll-trigger fade_in animation-order-2">
                        <div class="inner">
                            <div class="rbt-image-portion position-relative overflow-hidden">
                                <a href="#">
                                    <img class=" rbt-scroll-trigger zoom_in animation-order-2" src="{{ asset('assets/images/catagory-img/cat-bp-bg-a-02.webp') }}" alt="Catagory Product Images">
                                </a>
                                <div class="rbt-right-corner-portion bottom--position">
                                    <div class="rbt-corner-portion-wrapper">
                                        <a href="#" class="rbt-card-link-btn"><i class="fa-solid fa-arrow-up-right"></i></a>
                ...
                <div class="col-lg-1-5 col-md-4 col-6 mt--24">
                    <div class="rbt-cat-box rbt-cat-box-5 variation-one rbt-scroll-trigger fade_in animation-order-3">
                        <div class="inner">
                            <div class="rbt-image-portion position-relative overflow-hidden">
                                <a href="#">
                                    <img class=" rbt-scroll-trigger zoom_in animation-order-3" src="{{ asset('assets/images/catagory-img/cat-bp-bg-a-03.webp') }}" alt="Catagory Product Images">
                                </a>
                                <div class="rbt-right-corner-portion bottom--position">
                                    <div class="rbt-corner-portion-wrapper">
                                        <a href="#" class="rbt-card-link-btn"><i class="fa-solid fa-arrow-up-right"></i></a>
                ...
                <div class="col-lg-1-5 col-md-4 col-6 mt--24">
                    <div class="rbt-cat-box rbt-cat-box-5 variation-one rbt-scroll-trigger fade_in animation-order-4">
                        <div class="inner">
                            <div class="rbt-image-portion position-relative overflow-hidden">
                                <a href="#">
                                    <img class=" rbt-scroll-trigger zoom_in animation-order-4" src="{{ asset('assets/images/catagory-img/cat-bp-bg-a-04.webp') }}" alt="Catagory Product Images">
                                </a>
                                <div class="rbt-right-corner-portion bottom--position">
                                    <div class="rbt-corner-portion-wrapper">
                                        <a href="#" class="rbt-card-link-btn"><i class="fa-solid fa-arrow-up-right"></i></a>
                ...
                <div class="col-lg-1-5 col-md-4 col-6 mt--24">
                    <div class="rbt-cat-box rbt-cat-box-5 variation-one rbt-scroll-trigger fade_in animation-order-5">
                        <div class="inner">
                            <div class="rbt-image-portion position-relative overflow-hidden">
                                <a href="#">
                                    <img class=" rbt-scroll-trigger zoom_in animation-order-1" src="{{ asset('assets/images/catagory-img/cat-bp-bg-a-05.webp') }}" alt="Catagory Product Images">
                                </a>
                                <div class="rbt-right-corner-portion bottom--position">
                                    <div class="rbt-corner-portion-wrapper">
                                        <a href="#" class="rbt-card-link-btn"><i class="fa-solid fa-arrow-up-right"></i></a>
    ...
    <!-- Start Component Area -->
    <div class="rbt-component-area rbt-products-area">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="rbt-component-section-title rbt-gap--4 text-center border-0 p-0 align-items-center">
                                <span class="rbt-card-subtitle b1 rbt-text-color-heading mt--0 rbt-scroll-trigger fade_in animation-order-1">Top
                                    Rated Items</span>
                                <h2 class="rbt-title rbt-scroll-trigger fade_in animation-order-2"><span class="rbt-bold--text">Shop By </span>Best Items</h2>
                    ...
                    <div class="row row--12 mt_dec--24">
                        ...
                        <div class="col-lg-4 col-xl-3 col-xxl-3 col-md-6 col-sm-6 col-6 mt--24 mt_sm--16">
                            <div class="rbt-card rbt-product-card rbt-product-card-style-2 rounded--12 rbt-scroll-trigger fade_in animation-order-1">
                                <div class="rbt-card-img top-rounded-md">
                                    <a href="product-single-default.html"><img class="rbt-scroll-trigger fade_in animation-order-1 rbt-prd-img" src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-a-01.webp') }}" alt="Card Image"></a>
                                    ...
                                    <div class="rbt-card-top-content">
                                        <div class="rbt-product-switch-area">
                                            <ul class="rbt-switcher-product-list product-switcher-activation">
                                                <li class="active"><a class="rbt-switcher--prd rbt-switcher--prd-one" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-a-01.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-a-01.webp') }}" alt="Product Image"></a></li>
                                                <li><a class="rbt-switcher--prd rbt-switcher--prd-two" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-a-02.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-a-02.webp') }}" alt="Product Image"></a></li>
                                                <li><a class="rbt-switcher--prd rbt-switcher--prd-three" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-a-03.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-a-03.webp') }}" alt="Product Image"></a></li>
                                            </ul>
                                            <a class="prd-link-text" href="product-single-default.html">+7 More</a>
                                        </div>
                                        <a href="#" class="rbt-card-subtitle rbt-card-catagories-text mt--12">Makeup</a>
                                        <h2 class="rbt-card-title"><a href="product-single-default.html">Flawless Finish
                                                Liquid Duo</a></h2>
                        ...
                        <div class="col-lg-4 col-xl-3 col-xxl-3 col-md-6 col-sm-6 col-6 mt--24 mt_sm--16">
                            <div class="rbt-card rbt-product-card rbt-product-card-style-2 rounded--12 rbt-scroll-trigger fade_in animation-order-1">
                                <div class="rbt-card-img top-rounded-md">
                                    <a href="product-single-default.html"><img class="rbt-scroll-trigger fade_in animation-order-1 rbt-prd-img" src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-b-01.webp') }}" alt="Card Image"></a>
                                    <button class="rbt-wishlisted-btn rbt-round-btn bg-light-one rbt-top-right--position tooltips" type="button" data-tooltip="Add to wishlist" data-tooltip-position="left"><i class="fa-regular fa-heart"></i></button>
                                </div>
                                <div class="rbt-card-body rbt-bg-color-white">
                                    <div class="rbt-card-top-content">
                                        <div class="rbt-product-switch-area">
                                            <ul class="rbt-switcher-product-list product-switcher-activation">
                                                <li class="active"><a class="rbt-switcher--prd rbt-switcher--prd-one" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-b-01.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-b-01.webp') }}" alt="Product Image"></a></li>
                                                <li><a class="rbt-switcher--prd rbt-switcher--prd-two" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-b-02.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-b-02.webp') }}" alt="Product Image"></a></li>
                                                <li><a class="rbt-switcher--prd rbt-switcher--prd-three" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-b-03.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-b-03.webp') }}" alt="Product Image"></a></li>
                                            </ul>
                                            <a class="prd-link-text" href="product-single-default.html">+12 More</a>
                                        </div>
                                        <a href="#" class="rbt-card-subtitle rbt-card-catagories-text mt--12">Makeup</a>
                                        <h2 class="rbt-card-title"><a href="product-single-default.html">Mini Travel
                                                Palette</a></h2>
                                        <div class="rbt-card-rating">
                                            <ul class="rbt-rating-icon-list">
                                                <li><i class="fa-solid fa-star rbt-rated-icon"></i></li>
                        ...
                        <div class="col-lg-4 col-xl-3 col-xxl-3 col-md-6 col-sm-6 col-6 mt--24 mt_sm--16">
                            <div class="rbt-card rbt-product-card rbt-product-card-style-2 rounded--12 rbt-scroll-trigger fade_in animation-order-1">
                                <div class="rbt-card-img top-rounded-md">
                                    <a href="product-single-default.html"><img class="rbt-scroll-trigger fade_in animation-order-1 rbt-prd-img" src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-c-01.webp') }}" alt="Card Image"></a>
                                    <button class="rbt-wishlisted-btn rbt-round-btn bg-light-one rbt-top-right--position tooltips" type="button" data-tooltip="Add to wishlist" data-tooltip-position="left"><i class="fa-regular fa-heart"></i></button>
                                </div>
                                <div class="rbt-card-body rbt-bg-color-white">
                                    <div class="rbt-card-top-content">
                                        <div class="rbt-product-switch-area">
                                            <ul class="rbt-switcher-product-list product-switcher-activation">
                                                <li class="active"><a class="rbt-switcher--prd rbt-switcher--prd-one" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-c-01.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-c-01.webp') }}" alt="Product Image"></a></li>
                                                <li><a class="rbt-switcher--prd rbt-switcher--prd-two" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-c-02.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-c-02.webp') }}" alt="Product Image"></a></li>
                                                <li><a class="rbt-switcher--prd rbt-switcher--prd-three" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-c-03.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-c-03.webp') }}" alt="Product Image"></a></li>
                                            </ul>
                                            <a class="prd-link-text" href="product-single-default.html">+9 More</a>
                                        </div>
                                        <a href="#" class="rbt-card-subtitle rbt-card-catagories-text mt--12">Makeup</a>
                                        <h2 class="rbt-card-title"><a href="product-single-default.html">Hydrating Body
                                                Emulsion</a></h2>
                                        <div class="rbt-card-rating">
                                            <ul class="rbt-rating-icon-list">
                                                <li><i class="fa-solid fa-star rbt-rated-icon"></i></li>
                        ...
                        <div class="col-lg-4 col-xl-3 col-xxl-3 col-md-6 col-sm-6 col-6 mt--24 mt_sm--16">
                            <div class="rbt-card rbt-product-card rbt-product-card-style-2 rounded--12 rbt-scroll-trigger fade_in animation-order-1">
                                <div class="rbt-card-img top-rounded-md">
                                    <a href="product-single-default.html"><img class="rbt-scroll-trigger fade_in animation-order-1 rbt-prd-img" src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-d-01.webp') }}" alt="Card Image"></a>
                                    <button class="rbt-wishlisted-btn rbt-round-btn bg-light-one rbt-top-right--position tooltips" type="button" data-tooltip="Add to wishlist" data-tooltip-position="left"><i class="fa-regular fa-heart"></i></button>
                                </div>
                                <div class="rbt-card-body rbt-bg-color-white">
                                    <div class="rbt-card-top-content">
                                        <div class="rbt-product-switch-area">
                                            <ul class="rbt-switcher-product-list product-switcher-activation">
                                                <li class="active"><a class="rbt-switcher--prd rbt-switcher--prd-one" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-d-01.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-d-01.webp') }}" alt="Product Image"></a></li>
                                                <li><a class="rbt-switcher--prd rbt-switcher--prd-two" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-d-02.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-d-02.webp') }}" alt="Product Image"></a></li>
                                                <li><a class="rbt-switcher--prd rbt-switcher--prd-three" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-d-03.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-d-03.webp') }}" alt="Product Image"></a></li>
                                            </ul>
                                            <a class="prd-link-text" href="product-single-default.html">+12 More</a>
                                        </div>
                                        <a href="#" class="rbt-card-subtitle rbt-card-catagories-text mt--12">Makeup</a>
                                        <h2 class="rbt-card-title"><a href="product-single-default.html">Blush & Powder
                                                Compact</a></h2>
                                        <div class="rbt-card-rating">
                                            <ul class="rbt-rating-icon-list">
                                                <li><i class="fa-solid fa-star rbt-rated-icon"></i></li>
                        ...
                        <div class="col-lg-4 col-xl-3 col-xxl-3 col-md-6 col-sm-6 col-6 mt--24 mt_sm--16">
                            <div class="rbt-card rbt-product-card rbt-product-card-style-2 rounded--12 rbt-scroll-trigger fade_in animation-order-1">
                                <div class="rbt-card-img top-rounded-md">
                                    <a href="product-single-default.html"><img class="rbt-scroll-trigger fade_in animation-order-1 rbt-prd-img" src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-e-02.webp') }}" alt="Card Image"></a>
                                    <button class="rbt-wishlisted-btn rbt-round-btn bg-light-one rbt-top-right--position tooltips" type="button" data-tooltip="Add to wishlist" data-tooltip-position="left"><i class="fa-regular fa-heart"></i></button>
                                </div>
                                <div class="rbt-card-body rbt-bg-color-white">
                                    <div class="rbt-card-top-content">
                                        <div class="rbt-product-switch-area">
                                            <ul class="rbt-switcher-product-list product-switcher-activation">
                                                <li class="active"><a class="rbt-switcher--prd rbt-switcher--prd-one" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-e-02.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-e-02.webp') }}" alt="Product Image"></a></li>
                                                <li><a class="rbt-switcher--prd rbt-switcher--prd-two" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-e-01.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-e-01.webp') }}" alt="Product Image"></a></li>
                                                <li><a class="rbt-switcher--prd rbt-switcher--prd-three" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-e-03.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-e-03.webp') }}" alt="Product Image"></a></li>
                                            </ul>
                                            <a class="prd-link-text" href="product-single-default.html">+4 More</a>
                                        </div>
                                        <a href="#" class="rbt-card-subtitle rbt-card-catagories-text mt--12">Makeup</a>
                                        <h2 class="rbt-card-title"><a href="product-single-default.html">Long-Lasting
                                                AAA Batteries</a></h2>
                                        <div class="rbt-card-rating">
                                            <ul class="rbt-rating-icon-list">
                                                <li><i class="fa-solid fa-star rbt-rated-icon"></i></li>
                        ...
                        <div class="col-lg-4 col-xl-3 col-xxl-3 col-md-6 col-sm-6 col-6 mt--24 mt_sm--16">
                            <div class="rbt-card rbt-product-card rbt-product-card-style-2 rounded--12 rbt-scroll-trigger fade_in animation-order-1">
                                <div class="rbt-card-img top-rounded-md">
                                    <a href="product-single-default.html"><img class="rbt-scroll-trigger fade_in animation-order-1 rbt-prd-img" src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-f-01.webp') }}" alt="Card Image"></a>
                                    <button class="rbt-wishlisted-btn rbt-round-btn bg-light-one rbt-top-right--position tooltips" type="button" data-tooltip="Add to wishlist" data-tooltip-position="left"><i class="fa-regular fa-heart"></i></button>
                                </div>
                                <div class="rbt-card-body rbt-bg-color-white">
                                    <div class="rbt-card-top-content">
                                        <div class="rbt-product-switch-area">
                                            <ul class="rbt-switcher-product-list product-switcher-activation">
                                                <li class="active"><a class="rbt-switcher--prd rbt-switcher--prd-one" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-f-01.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-f-01.webp') }}" alt="Product Image"></a></li>
                                                <li><a class="rbt-switcher--prd rbt-switcher--prd-two" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-f-02.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-f-02.webp') }}" alt="Product Image"></a></li>
                                                <li><a class="rbt-switcher--prd rbt-switcher--prd-three" data-src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-f-03.webp') }}" href="#"><img src="{{ asset('assets/images/product-img/beauty-product/beauty-product-new-hfour-f-03.webp') }}" alt="Product Image"></a></li>
                                            </ul>
                                            <a class="prd-link-text" href="product-single-default.html">+6 More</a>
                                        </div>
                                        <a href="#" class="rbt-card-subtitle rbt-card-catagories-text mt--12">Makeup</a>
                                        <h2 class="rbt-card-title"><a href="product-single-default.html">Radiant Skin
                                                Foundation Set</a></h2>
                                        <div class="rbt-card-rating">
                                            <ul class="rbt-rating-icon-list">
                                                <li><i class="fa-solid fa-star rbt-rated-icon"></i></li>
                            ...
                            <div class="rbt-card rbt-product-card rbt-product-card-style-2 rounded--12 rbt-scroll-trigger fade_in animation-order-1">
                                ...
                                <div class="rbt-card-body rbt-bg-color-white">
                                    <div class="rbt-card-top-content">
                                        ...
                                        <a href="#" class="rbt-card-subtitle rbt-card-catagories-text mt--12">Makeup</a>
                                        <h2 class="rbt-card-title"><a href="product-single-default.html">Pocket-Sized
                                                Color Palette</a></h2>
                                        <div class="rbt-card-rating">
                                            <ul class="rbt-rating-icon-list">
                                                <li><i class="fa-solid fa-star rbt-rated-icon"></i></li>
                            ...
                            <div class="rbt-card rbt-product-card rbt-product-card-style-2 rounded--12 rbt-scroll-trigger fade_in animation-order-1">
                                ...
                                <div class="rbt-card-body rbt-bg-color-white">
                                    <div class="rbt-card-top-content">
                                        ...
                                        <a href="#" class="rbt-card-subtitle rbt-card-catagories-text mt--12">Makeup</a>
                                        <h2 class="rbt-card-title"><a href="product-single-default.html">Lip Color
                                                Trio</a></h2>
                                        <div class="rbt-card-rating">
                                            <ul class="rbt-rating-icon-list">
                                                <li><i class="fa-solid fa-star rbt-rated-icon"></i></li>
    ...
    <div class="rbt-component-area rbt-counterdown-area rbt-bg-color-white rbt-section-gapTop">
        <div class="container">
            ...
            <div class="rbt-counterdown-section rbt-counterdown-section-style-two rbt-scroll-trigger zoom_in animation-order-1 rbt-bg-color-gray-100">
                <div class="row row--0 justify-content-end">
                    <div class="col-xl-6 col-md-12 col-12">
                        <div class="rbt-product-banner-img rbt-scroll-trigger zoom_in animation-order-3 w-auto">
                            <img src="{{ asset('assets/images/product-banner/product-banner-img-bp-cd-01.webp') }}" alt="Ecommerce Product Banner Image">
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-12 col-12">
                        <div class="rbt-counterdown-content rbt-counterdown-content-right-position">
                            ...
                            <h2 class="rbt-title rbt-scroll-trigger fade_in animation-order-2 rbt-text-regular"><span class="rbt-bold--text">Up to 40% Off</span> On All Product</h2>
    ...
    <!-- Start Component Area -->
    <div class="rbt-component-area rbt-section-gapTop">
        <div class="container">

            <div class="row">
                <div class="col-lg-12">
                    <div class="rbt-component-section-title rbt-gap--4 text-center border-0 p-0  mb--32 align-items-center">
                        <h2 class="rbt-title rbt-scroll-trigger fade_in animation-order-2">Meet The <span class="rbt-bold--text">Skin Influencers</span></h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row row--12 mt_dec--24 rbt-mobile-row">
                <!-- Start Single Card -->
                <div class="col-lg-1-5 col-xl-3 col-xxl-3 col-md-6 col-sm-12 col-12 mt--24">
                    <div class="rbt-instagram-card">
                        <div class="instagram-thumbnail">
                            <img src="{{ asset('assets/images/insta-posts/insta-influ-a-01.webp') }}" alt="Instagram Post">
                            <a class="rbt-btn rounded-player popup-video rbtplayer sm-size bg-var-three rbt-magnetic-button" data-rbt-position-vertical="50" data-rbt-position-horigental="50" href="https://www.youtube.com/watch?v=abFXQQzFVDc" data-fancybox="">
                                <span><i class="fa-solid fa-play"></i></span>
                            </a>
                        </div>
                        <span class="rbt-instagram-caption h6">
                            <a href="https://www.youtube.com/watch?v=abFXQQzFVDc" data-fancybox=""><strong>@madisona</strong> - Mateau Lip and Cheek Glow..</a>
                        </span>
                    </div>
                </div>
                <!-- End Single Card -->
                ...
                <div class="col-lg-1-5 col-xl-3 col-xxl-3 col-md-6 col-sm-12 col-12 mt--24">
                    <div class="rbt-instagram-card">
                        <div class="instagram-thumbnail">
                            <img src="{{ asset('assets/images/insta-posts/insta-influ-a-02.webp') }}" alt="Instagram Post">
                            <a class="rbt-btn rounded-player popup-video rbtplayer sm-size bg-var-three rbt-magnetic-button" data-rbt-position-vertical="50" data-rbt-position-horigental="50" href="https://www.youtube.com/watch?v=abFXQQzFVDc" data-fancybox="">
                                <span><i class="fa-solid fa-play"></i></span>
                            </a>
                        </div>
                        <span class="rbt-instagram-caption h6">
                            <a href="https://www.youtube.com/watch?v=abFXQQzFVDc" data-fancybox=""><strong>@salniea</strong> - Alkina's Featured Shades</a>
                        </span>
                    </div>
                </div>
                <!-- End Single Card -->
                ...
                <div class="col-lg-1-5 col-xl-3 col-xxl-3 col-md-6 col-sm-12 col-12 mt--24">
                    <div class="rbt-instagram-card">
                        <div class="instagram-thumbnail">
                            <img src="{{ asset('assets/images/insta-posts/insta-influ-a-03.webp') }}" alt="Instagram Post">
                            <a class="rbt-btn rounded-player popup-video rbtplayer sm-size bg-var-three rbt-magnetic-button" data-rbt-position-vertical="50" data-rbt-position-horigental="50" href="https://www.youtube.com/watch?v=abFXQQzFVDc" data-fancybox="">
                                <span><i class="fa-solid fa-play"></i></span>
                            </a>
                        </div>
                        <span class="rbt-instagram-caption h6">
                            <a href="https://www.youtube.com/watch?v=abFXQQzFVDc" data-fancybox=""><strong>@jaquiline</strong> - Mateau Glow: As on Madisona</a>
                        </span>
                    </div>
                </div>
                <!-- End Single Card -->
                ...
                <div class="col-lg-1-5 col-xl-3 col-xxl-3 col-md-6 col-sm-12 col-12 mt--24">
                    <div class="rbt-instagram-card">
                        <div class="instagram-thumbnail">
                            <img src="{{ asset('assets/images/insta-posts/insta-influ-a-04.webp') }}" alt="Instagram Post">
                            <a class="rbt-btn rounded-player popup-video rbtplayer sm-size bg-var-three rbt-magnetic-button" data-rbt-position-vertical="50" data-rbt-position-horigental="50" href="https://www.youtube.com/watch?v=abFXQQzFVDc" data-fancybox="">
                                <span><i class="fa-solid fa-play"></i></span>
                            </a>
                        </div>
                        <span class="rbt-instagram-caption h6">
                            <a href="https://www.youtube.com/watch?v=abFXQQzFVDc" data-fancybox=""><strong>@nancy</strong> - Skin Influencer: nancy Glow</a>
                        </span>
                    </div>
                </div>
                <!-- End Single Card -->
                ...
                <div class="col-lg-1-5 col-xl-3 col-xxl-3 col-md-6 col-sm-12 col-12 mt--24">
                    <div class="rbt-instagram-card">
                        <div class="instagram-thumbnail">
                            <img src="{{ asset('assets/images/insta-posts/insta-influ-a-05.webp') }}" alt="Instagram Post">
                            <a class="rbt-btn rounded-player popup-video rbtplayer sm-size bg-var-three rbt-magnetic-button" data-rbt-position-vertical="50" data-rbt-position-horigental="50" href="https://www.youtube.com/watch?v=abFXQQzFVDc" data-fancybox="">
                                <span><i class="fa-solid fa-play"></i></span>
                            </a>
                        </div>
                        <span class="rbt-instagram-caption h6">
                            <a href="https://www.youtube.com/watch?v=abFXQQzFVDc" data-fancybox=""><strong>@janialw</strong> - The Influencer nice and charming Glow..</a>
                        </span>
                    </div>
                </div>
                <!-- End Single Card -->
    ...
    <!-- Start Component Area -->
    <div class="rbt-component-area rbt-brands-area rbt-bg-color-white rbt-section-gap2">
        <div class="rbt-fullwidth-wrapper">
            <div class="rbt-gray-contain-box rbt-gray-contain-box-style-one has-bg-image has-bg-image-01 pt--80 pb--80">
                <div class="container">

                    <div class="row">
                        <div class="col-lg-12">
                            <div class="rbt-component-section-title rbt-gap--4 mb--40 p-0 border-0 text-center align-items-center">
                                <span class="rbt-card-subtitle b1 rbt-text-color-heading mt--0 rbt-scroll-trigger zoom_in animation-order-1">Today’s
                                    best deals</span>
                                <h2 class="rbt-title rbt-scroll-trigger zoom_in animation-order-2"><span class="rbt-bold--text">Trending </span>Brands</h2>
                                <a class="rbt-btn-link rbt-text-color-primary d-flex rbt-text-medium rbt-gap--8 mt--8 justify-content-center rbt-scroll-trigger zoom_in animation-order-3" href="#">
                                    <span class="btn-text">View All Brands</span>
                                    <span class="btn-icon"><i class="fa-sharp fa-solid fa-arrow-up-right-from-square"></i></span>
                                </a>
                            </div>
                        </div>
                    </div>
...
<div class="row row--12 mt_dec--60">
        ...
        <div class="rbt-brand text-center style-three rbt-scroll-trigger fade_in animation-order-1">
            <div class="inner">
                <div class="brand-image rbt-scroll-trigger zoom_in animation-order-1">
                    <img src="{{ asset('assets/images/brands/brand-c-01.webp') }}" alt="Ecommerce Brand Images">
                </div>
                <p class="desc">“Allure makeup brand Sunnies 
                    Face makes just one lipstick and it’s constantly selling out.”
                </p>
        ...
        <div class="rbt-brand text-center style-three rbt-scroll-trigger fade_in animation-order-2">
            <div class="inner">
                <div class="brand-image rbt-scroll-trigger zoom_in animation-order-2">
                    <img src="{{ asset('assets/images/brands/brand-c-02.webp') }}" alt="Ecommerce Brand Images">
                </div>
                <p class="desc">“Allure makeup brand Sunnies 
                    Face makes just one lipstick and it’s constantly selling out.”
                </p>
        ...
        <div class="rbt-brand text-center style-three rbt-scroll-trigger fade_in animation-order-3">
            <div class="inner">
                <div class="brand-image rbt-scroll-trigger zoom_in animation-order-3">
                    <img src="{{ asset('assets/images/brands/brand-c-03.webp') }}" alt="Ecommerce Brand Images">
                </div>
                <p class="desc">“Allure makeup brand Sunnies 
                    Face makes just one lipstick and it’s constantly selling out.”
                </p>
        ...
        <div class="rbt-brand text-center style-three rbt-scroll-trigger fade_in animation-order-4">
            <div class="inner">
                <div class="brand-image rbt-scroll-trigger zoom_in animation-order-4">
                    <img src="{{ asset('assets/images/brands/brand-c-04.webp') }}" alt="Ecommerce Brand Images">
                </div>
                <p class="desc">“Allure makeup brand Sunnies 
                    Face makes just one lipstick and it’s constantly selling out.”
                </p>
    ...
    <div class="col-lg-1-5 col-lg-4 col-md-4 col-sm-6 col-6 mt--60">
        <div class="rbt-brand text-center style-three rbt-scroll-trigger fade_in animation-order-5">
            <div class="inner">
                <div class="brand-image rbt-scroll-trigger zoom_in animation-order-1">
                    <img src="{{ asset('assets/images/brands/brand-c-05.webp') }}" alt="Ecommerce Brand Images">
                </div>
                <p class="desc">“Allure makeup brand Sunnies 
                    Face makes just one lipstick and it’s constantly selling out.”
                </p>
    ...
    <div class="rbt-component-area rbt-instapost-area rbt-bg-color-white rbt-section-gap2Bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="rbt-component-section-title rbt-gap--4 mb--40 p-0 border-0 text-center align-items-center">
                        <span class="rbt-card-subtitle b1 rbt-text-color-heading mt--0 rbt-scroll-trigger fade_in animation-order-1">View
                            & Follow</span>
                        <h2 class="rbt-title rbt-scroll-trigger fade_in animation-order-2">Us <span class="rbt-bold--text">@instagram</span></h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row row--12 mt_dec--16 justify-content-center">
                <div class="col-lg-2 col-md-4 col-sm-4 col-4 mt--16 d-flex justify-content-center">
                    <div class="rbt-instapost text-center rbt-instapost-style-one rbt-scroll-trigger fade_in animation-order-1">
                        <div class="inner" data-bs-toggle="modal" data-bs-target="#instaModal">
                            <a href="#!" class="instapost-img">
                                <img class="rbt-scroll-trigger zoom_in animation-order-1" src="{{ asset('assets/images/insta-posts/insta-post-cb-hfour-01.webp') }}" alt="Ecommerce Brand Images">
                            </a>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 col-4 mt--16 d-flex justify-content-center">
                    <div class="rbt-instapost text-center rbt-instapost-style-one rbt-scroll-trigger fade_in animation-order-2">
                        <div class="inner" data-bs-toggle="modal" data-bs-target="#instaModal">
                            <a href="#!" class="instapost-img">
                                <img class="rbt-scroll-trigger zoom_in animation-order-2" src="{{ asset('assets/images/insta-posts/insta-post-cb-hfour-02.webp') }}" alt="Ecommerce Brand Images">
                            </a>
                            <div class="instapost-content">
                                <span class="insta-icon">
                                    <i class="fa-brands fa-instagram"></i>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 col-4 mt--16 d-flex justify-content-center">
                    <div class="rbt-instapost text-center rbt-instapost-style-one rbt-scroll-trigger fade_in animation-order-3">
                        <div class="inner" data-bs-toggle="modal" data-bs-target="#instaModal">
                            <a href="#!" class="instapost-img">
                                <img class="rbt-scroll-trigger zoom_in animation-order-3" src="{{ asset('assets/images/insta-posts/insta-post-cb-hfour-03.webp') }}" alt="Ecommerce Brand Images">
                            </a>
                            <div class="instapost-content">
                                <span class="insta-icon">
                                    <i class="fa-brands fa-instagram"></i>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 col-4 mt--16 d-flex justify-content-center">
                    <div class="rbt-instapost text-center rbt-instapost-style-one rbt-scroll-trigger fade_in animation-order-4">
                        <div class="inner" data-bs-toggle="modal" data-bs-target="#instaModal">
                            <a href="#!" class="instapost-img">
                                <img class="rbt-scroll-trigger zoom_in animation-order-4" src="{{ asset('assets/images/insta-posts/insta-post-cb-hfour-04.webp') }}" alt="Ecommerce Brand Images">
                            </a>
                            <div class="instapost-content">
                                <span class="insta-icon">
                                    <i class="fa-brands fa-instagram"></i>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 col-4 mt--16 d-flex justify-content-center">
                    <div class="rbt-instapost text-center rbt-instapost-style-one rbt-scroll-trigger fade_in animation-order-5">
                        <div class="inner" data-bs-toggle="modal" data-bs-target="#instaModal">
                            <a href="#!" class="instapost-img">
                                <img class="rbt-scroll-trigger zoom_in animation-order-5" src="{{ asset('assets/images/insta-posts/insta-post-b-05.webp') }}" alt="Ecommerce Brand Images">
                            </a>
                            <div class="instapost-content">
                                <span class="insta-icon">
                                    <i class="fa-brands fa-instagram"></i>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 col-4 mt--16 d-flex justify-content-center">
                    <div class="rbt-instapost text-center rbt-instapost-style-one rbt-scroll-trigger fade_in animation-order-1">
                        <div class="inner" data-bs-toggle="modal" data-bs-target="#instaModal">
                            <a href="#!" class="instapost-img">
                                <img class="rbt-scroll-trigger zoom_in animation-order-6" src="{{ asset('assets/images/insta-posts/insta-post-cb-hfour-05.webp') }}" alt="Ecommerce Brand Images">
                            </a>
                            <div class="instapost-content">
                                <span class="insta-icon">
                                    <i class="fa-brands fa-instagram"></i>
        ...
        <div class="row">
                ...
                <div class="row rbt-compare-products">
                    <div class="col-10 col-md-3 col-lg-3">
                        <div class="rbt-card rbt-comparison-prd-box">
                            ...
                            <div class="rbt-comparison-prd-img">
                                <a href="product-single-default.html">
                                    <img src="{{ asset('assets/images/product-img/electronics/electronics-bg-trans-05-a-1.webp') }}" alt="Product Image">
                                </a>
                            </div>
                    ...
                    <div class="col-10 col-md-3 col-lg-3">
                        <div class="rbt-card rbt-comparison-prd-box">
                            ...
                            <div class="rbt-comparison-prd-img">
                                <a href="product-single-default.html">
                                    <img src="{{ asset('assets/images/product-img/electronics/electronics-bg-trans-06-a-1.webp') }}" alt="Product Image">
                                </a>
                            </div>
                            <h2 class="rbt-product-title h6">
                    ...
                    <div class="col-10 col-md-3 col-lg-3">
                        <div class="rbt-card rbt-comparison-prd-box">
                            ...
                            <div class="rbt-comparison-prd-img">
                                <a href="product-single-default.html">
                                    <img src="{{ asset('assets/images/product-img/electronics/electronics-bg-trans-07-a-1.webp') }}" alt="Product Image">
                                </a>
                            </div>
                            <h2 class="rbt-product-title h6">
                    ...
                    <div class="col-10 col-md-3 col-lg-3">
                        <div class="rbt-card rbt-comparison-prd-box">
                            ...
                            <div class="rbt-comparison-prd-img">
                                <a href="product-single-default.html">
                                    <img src="{{ asset('assets/images/product-img/electronics/electronics-bg-trans-08-a-1.webp') }}" alt="Product Image">
                                </a>
                            </div>
                            <h2 class="rbt-product-title h6">
                                <a href="product-single-default.html">Sony Alpha A7 IV Full-Frame Camera</a>
            ...
            <div class="col-12 col-lg-3 col-xl-2">
                <div class="rbt-popup-action-area justify-content-center">
                    <a class="rbt-btn rbt-btn-sm rbt-square-btn has-left-icon mb--12" href="#"><i class="fa-regular fa-scale-balanced"></i> Compare Now</a>
                    <a class="rbt-btn rbt-btn-border rbt-btn-sm rbt-square-btn has-left-icon mb--12" href="{{ route('shop') }}"><i class="fa-regular fa-browser"></i> Browse Products</a>
...
<div class="rbt-default-modal rbt-added-comparison-modal modal fade has-rbt-top-folder-shape" id="addedcomparisonModal" tabindex="-1" role="dialog" aria-modal="true" aria-labelledby="addedcomparisonModalLabel" aria-hidden="true">
                ...
                <div class="rbt-comparison-popup-area rbt-bg-color-white rbt-content-trs-portion">
                    <div class="inner">
                        <div class="rbt-comparison-prd-box">
                            <div class="rbt-comparison-prd-img">
                                <img src="{{ asset('assets/images/product-img/electronics/electronics-bg-trans-01.webp') }}" alt="Product Image">
                            </div>
                            <h2 class="rbt-product-title h6" id="addedcomparisonModalLabel">G244F 23.8 inch FHD 4k Rapid
                        ...
                        <div class="rbt-popup-action-area text-center">
                            ...
                            <a class="rbt-btn rbt-btn-sm rbt-square-btn d-block has-left-icon mb--12" href="#"><i class="fa-regular fa-scale-balanced"></i> Compare Now</a>
                            <a class="rbt-btn rbt-btn-border rbt-btn-sm rbt-square-btn d-block has-left-icon" href="#"><i class="fa-regular fa-browser"></i> Browse Products</a>
                        </div>
                    </div>
                </div>
                <!-- End Component Area -->
...
<!-- End Quick View Modal Area  -->
    <!-- Start Modal Area  -->
<div class="rbt-default-modal modal fade rbt-insta-single-modal has-rbt-top-folder-shape" id="instaModal" tabindex="-1" role="dialog" aria-modal="true" aria-labelledby="instaModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="row row--16">
                            <div class="col-lg-6 col-md-12 col-12">
                                <div class="rbt-single-insta-img">
                                    <img src="{{ asset('assets/images/insta-posts/insta-post-single-01.webp') }}" alt="Unimart instagram Single Post Image">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-12">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="rbt-component-section-title text-center">
                                            <h2 class="rbt-title h4" id="instaModalLabel">Products In <span class="rbt-bold--text">Image</span></h2>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="rbt-right-modal-content">
                                    ...
                                    <div class="row row--12 mb--24 mt_dec--24">
                                        ...
                                        <div class="col-lg-6 col-xl-6 col-6 mt--24">
                                            <div class="rbt-card rbt-product-card">
                                                <div class="rbt-card-img top-rounded-md rbt-bg-color-gray-light">
                                                    <a href="product-single-default.html"><img src="{{ asset('assets/images/product-img/fashion/single-insta-post-01.webp') }}" alt="Card Image"></a>
                                                    <div class="rbt-product-badge rbt-product-badge-bg-primary rbt-badge-top-left--position">
                                                        SALE</div>
                                                    <button class="rbt-wishlisted-btn rbt-round-btn bg-light-one rbt-top-right--position tooltips" type="button" data-tooltip="Add to wishlist" data-tooltip-position="left"><i class="fa-regular fa-heart"></i></button>
                                                </div>
                                                <div class="rbt-card-body">
                                                    <a href="#" class="rbt-card-subtitle rbt-card-catagories-text">Ladies
                                                        Baf</a>
                                                    <h3 class="rbt-card-title h6"><a href="product-single-default.html">Bella HAY Side Table Oxd
                                        ...
                                        <div class="col-lg-6 col-xl-6 col-6 mt--24">
                                            <div class="rbt-card rbt-product-card">
                                                <div class="rbt-card-img top-rounded-md rbt-bg-color-gray-light">
                                                    <a href="product-single-default.html"><img src="{{ asset('assets/images/product-img/fashion/single-insta-post-02.webp') }}" alt="Card Image"></a>
                                                    <button class="rbt-wishlisted-btn rbt-round-btn bg-light-one rbt-top-right--position tooltips" type="button" data-tooltip="Add to wishlist" data-tooltip-position="left"><i class="fa-regular fa-heart"></i></button>
                                                </div>
                                                <div class="rbt-card-body">
                                                    <a href="#" class="rbt-card-subtitle rbt-card-catagories-text">Fashion</a>
                                                    <h3 class="rbt-card-title h6"><a href="product-single-default.html">Cnvrs All Star Disrupt Cx
                                        ...
                                        <div class="col-lg-6 col-xl-6 col-6 mt--24">
                                            <div class="rbt-card rbt-product-card">
                                                <div class="rbt-card-img top-rounded-md rbt-bg-color-gray-light">
                                                    <a href="product-single-default.html"><img src="{{ asset('assets/images/product-img/fashion/sunglass-03.webp') }}" alt="Card Image"></a>
                                                    <div class="rbt-product-badge rbt-product-badge-bg-primary rbt-badge-top-left--position">
                                                        SALE</div>
                                                    <button class="rbt-wishlisted-btn rbt-round-btn bg-light-one rbt-top-right--position tooltips" type="button" data-tooltip="Add to wishlist" data-tooltip-position="left"><i class="fa-regular fa-heart"></i></button>
                                                </div>
                                                <div class="rbt-card-body">
                                                    <a href="#" class="rbt-card-subtitle rbt-card-catagories-text">Sunglass</a>
                                                    <h3 class="rbt-card-title h6"><a href="product-single-default.html">HK
                                        ...
                                        <div class="col-lg-6 col-xl-6 col-6 mt--24">
                                            <div class="rbt-card rbt-product-card">
                                                <div class="rbt-card-img top-rounded-md rbt-bg-color-gray-light">
                                                    <a href="product-single-default.html"><img src="{{ asset('assets/images/product-img/fashion/sunglass-04.webp') }}" alt="Card Image"></a>
                                                    <button class="rbt-wishlisted-btn rbt-round-btn bg-light-one rbt-top-right--position tooltips" type="button" data-tooltip="Add to wishlist" data-tooltip-position="left"><i class="fa-regular fa-heart"></i></button>
                                                </div>
                                                <div class="rbt-card-body">
                                                    <a href="#" class="rbt-card-subtitle rbt-card-catagories-text">Sunglass</a>
                                                    <h3 class="rbt-card-title h6"><a href="product-single-default.html">Eyesafe Smart Best
...
<!-- End Quick View Modal Area  -->
    <!-- Start Quick View Modal Area  -->
<div class="rbt-product-restock-modal-area rbt-default-modal modal fade" id="quickViewRestockModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content p-0">
                            ...
                            <div class="rbt-scroll-vertical content">
                                ...
                                <div class="rbt-info-wrapper d-flex mt--20">
                                    <div class="product-styles-grp d-flex mt--0">
                                        ...
                                        <div class="content d-flex flex-wrap">
                                            <a class="rbt-btn rbt-btn-border rbt-btn-sm rbt-square-btn" href="#">Charger</a>
                                            <a class="rbt-btn rbt-btn-border rbt-btn-sm rbt-square-btn" href="#">Audio
                                                Port</a>
                                            <a class="rbt-btn rbt-btn-border rbt-btn-sm rbt-square-btn" href="#">Type C
                                                Jack</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row row--16">
                    <div class="col-md-6 col-12 mt--16">
                        <div class="rbt-card rbt-product-card">
                            ...
                            <div class="rbt-card-body">
                                <p class="rbt-title mb--0 b1"><a href="product-single-default.html">Harman Kardon Aura
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="rbt-card rbt-product-card rbt-list-view-variation list-view-md">
                                <div class="inner">
                                    <div class="rbt-card-img rbt-bg-color-default">
                                        <a href="product-single-default.html"><img src="{{ asset('assets/images/product-img/electronics/electronics-bg-trans-01.webp') }}" alt="Card Image"></a>
                                    </div>
                                    <div class="rbt-card-body p-0">
                                        <a href="#" class="rbt-card-subtitle rbt-card-catagories-text">Headphones</a>
                                        <p class="rbt-card-title mt--0 b4"><a href="product-single-default.html">Samsung
                        ...
                        <div class="swiper-slide">
                            <div class="rbt-card rbt-product-card rbt-list-view-variation list-view-md">
                                <div class="inner">
                                    <div class="rbt-card-img rbt-bg-color-default">
                                        <a href="product-single-default.html"><img src="{{ asset('assets/images/product-img/electronics/electronics-bg-trans-02.webp') }}" alt="Card Image"></a>
                                    </div>
                                    <div class="rbt-card-body p-0">
                                        <a href="#" class="rbt-card-subtitle rbt-card-catagories-text">Coffee
                                            Machine</a>
                                        <p class="rbt-card-title mt--0 b4"><a href="product-single-default.html">Nespresso Vertuo Plus Coffee
                                                Machine</a></p>
                                        <div class="pricing-part mt--0">
                        ...
                        <div class="swiper-slide">
                            <div class="rbt-card rbt-product-card rbt-list-view-variation list-view-md">
                                <div class="inner">
                                    <div class="rbt-card-img rbt-bg-color-default">
                                        <a href="product-single-default.html"><img src="{{ asset('assets/images/product-img/electronics/electronics-bg-trans-03.webp') }}" alt="Card Image"></a>
                                    </div>
                                    <div class="rbt-card-body p-0">
                                        <a href="#" class="rbt-card-subtitle rbt-card-catagories-text">Smartwatch</a>
                                        <p class="rbt-card-title mt--0 b4"><a href="product-single-default.html">Fitbit
                ...
                <div class="rbt-bg-color-white rbt-content-trs-portion">
                    ...
                    <div class="rbt-social-share-wrapper">
                        ...
                        <ul class="social-icon rbt-social-default mt--16 mt_sm--0 rbt-social-default-v1 lg-size justify-content-start">
                            ...
                            <li>
                                <a class="email-btn" href="/cdn-cgi/l/email-protection#4a3925272f25242f0a2f322b273a262f64292527">
                        ...
                        <li>
                            <div class="rbt-inf-box flex-row">
                                ...
                                <div class="rbt-inf-box-content align-items-start">
                                    <h2 class="rbt-inf-box-title">Free Shipping</h2>
                                    <p class="rbt-inf-box-desc">From all orders over $100</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="rbt-inf-box flex-row">
                                ...
                                <div class="rbt-inf-box-content align-items-start">
                                    <h2 class="rbt-inf-box-title">Quality Support</h2>
                                    <p class="rbt-inf-box-desc">24/7 online feedback</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="rbt-inf-box flex-row">
                                ...
                                <div class="rbt-inf-box-content align-items-start">
                                    <h2 class="rbt-inf-box-title">Return & Refund</h2>
                                    <p class="rbt-inf-box-desc">Return money within 30 days</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="rbt-inf-box flex-row">
                                ...
                                <div class="rbt-inf-box-content align-items-start">
                                    <h2 class="rbt-inf-box-title">Gift Voucher</h2>
                                    <p class="rbt-inf-box-desc">20% off when you shop online</p>
                                </div>
                            </div>
                        </li>
                    </ul>
